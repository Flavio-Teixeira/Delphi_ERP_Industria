unit Contas_Receber_Orcamento_00;
...
type
  TContasReceberOrcamento00 = class(TForm)
    Panel1: TPanel;
    Label1: TLabel;
    Label4: TLabel;
...
var
  ContasReceberOrcamento00: TContasReceberOrcamento00;

implementation

uses Conexao_BD, Rotinas_Gerais, Clientes_00, Contas_Receber_Orcamento_01;

{$R *.dfm}

procedure TContasReceberOrcamento00.BT_SairClick(Sender: TObject);
begin
     ContasReceberOrcamento00.Close;
end;

procedure TContasReceberOrcamento00.BT_ProcurarClick(Sender: TObject);
...
procedure TContasReceberOrcamento00.BT_Procura_ClienteClick(Sender: TObject);
begin
     ContasReceberOrcamento00.Visible := False;
     ...
     If (Clientes00 = Nil) Then
        ...
        Clientes00.Programa_Anterior.Text := 'ContasReceberOrcamento';
     End;
     ...
     ContasReceberOrcamento00.Visible := True;
...
procedure TContasReceberOrcamento00.FormShow(Sender: TObject);
begin
     Data_Inicial.SetFocus;
end;

procedure TContasReceberOrcamento00.BT_ImprimirClick(Sender: TObject);
...
begin
     ...
     If Trim(Numero_Docto.Text) <> '' Then
        Begin
        Comando_SQL_2 := 'Select * from fb_papeletas Where fb_papeleta_natureza_oper = '+#39+'Vendas'+#39+' And ';
        Comando_SQL_2 := Comando_SQL_2 + '((fb_papeleta_numero = ' + Trim(Numero_Docto.Text) + ') Or ';
        Comando_SQL_2 := Comando_SQL_2 + '(fb_papeleta_dup_nro_1 = ' +#39+ Trim(Numero_Docto.Text) +#39+ ') Or ';
        Comando_SQL_2 := Comando_SQL_2 + '(fb_papeleta_dup_nro_2 = ' +#39+ Trim(Numero_Docto.Text) +#39+ ') Or ';
        Comando_SQL_2 := Comando_SQL_2 + '(fb_papeleta_dup_nro_3 = ' +#39+ Trim(Numero_Docto.Text) +#39+ ') Or ';
        Comando_SQL_2 := Comando_SQL_2 + '(fb_papeleta_dup_nro_4 = ' +#39+ Trim(Numero_Docto.Text) +#39+ ')) ';
        Comando_SQL_2 := Comando_SQL_2 + ' Order By fb_papeleta_numero';
     ...
     Else If Opc_Data_Emissao.Checked Then
        ...
        Else
           ...
           If (Trim(Cliente_Codigo.Text) <> '') And (Trim(Cliente_Codigo.Text) <> '0') Then
              ...
              Comando_SQL_2 := 'Select * from fb_papeletas Where fb_papeleta_natureza_oper = '+#39+'Vendas'+#39+' And ';
              Comando_SQL_2 := Comando_SQL_2 + '((fb_papeleta_data_emissao >='+#39+Inverte_Data_Plus(Trim(Data_Inicial.Text),'amd','/')+#39+') and (fb_papeleta_data_emissao <='+#39+Inverte_Data_Plus(Trim(Data_Final.Text),'amd','/')+#39+')) ';
              Comando_SQL_2 := Comando_SQL_2 + 'And (fb_papeleta_codigo = ' +#39+ Trim(Cliente_Codigo.Text) +#39+ ') ';
              Comando_SQL_2 := Comando_SQL_2 + ' Order By fb_papeleta_numero';
     ...
     Else If Opc_Data_Vencto.Checked Then
        ...
        Else
           ...
           If (Trim(Cliente_Codigo.Text) <> '') And (Trim(Cliente_Codigo.Text) <> '0') Then
              ...
              Comando_SQL_2 := 'Select * from fb_papeletas Where fb_papeleta_natureza_oper = '+#39+'Vendas'+#39+' And ';
              Comando_SQL_2 := Comando_SQL_2 + '(((fb_papeleta_dup_dt_vcto_1 >='+#39+Inverte_Data_Plus(Trim(Data_Inicial.Text),'amd','/')+#39+') and (fb_papeleta_dup_dt_vcto_1 <='+#39+Inverte_Data_Plus(Trim(Data_Final.Text),'amd','/')+#39+')) Or ';
              Comando_SQL_2 := Comando_SQL_2 + '((fb_papeleta_dup_dt_vcto_2 >='+#39+Inverte_Data_Plus(Trim(Data_Inicial.Text),'amd','/')+#39+') and (fb_papeleta_dup_dt_vcto_2 <='+#39+Inverte_Data_Plus(Trim(Data_Final.Text),'amd','/')+#39+')) Or ';
              Comando_SQL_2 := Comando_SQL_2 + '((fb_papeleta_dup_dt_vcto_3 >='+#39+Inverte_Data_Plus(Trim(Data_Inicial.Text),'amd','/')+#39+') and (fb_papeleta_dup_dt_vcto_3 <='+#39+Inverte_Data_Plus(Trim(Data_Final.Text),'amd','/')+#39+')) Or ';
              Comando_SQL_2 := Comando_SQL_2 + '((fb_papeleta_dup_dt_vcto_4 >='+#39+Inverte_Data_Plus(Trim(Data_Inicial.Text),'amd','/')+#39+') and (fb_papeleta_dup_dt_vcto_4 <='+#39+Inverte_Data_Plus(Trim(Data_Final.Text),'amd','/')+#39+'))) ';
              Comando_SQL_2 := Comando_SQL_2 + 'And (fb_papeleta_codigo = ' +#39+ Trim(Cliente_Codigo.Text) +#39+ ') ';
              Comando_SQL_2 := Comando_SQL_2 + ' Order By fb_papeleta_numero';
     ...
     Else If Opc_Em_Aberto.Checked Then
        ...
        Else
           ...
           If (Trim(Cliente_Codigo.Text) <> '') And (Trim(Cliente_Codigo.Text) <> '0') Then
              ...
              Comando_SQL_2 := Comando_SQL_2 + '((fb_papeleta_dup_dt_vcto_2 >='+#39+Inverte_Data_Plus(Trim(Data_Inicial.Text),'amd','/')+#39+') and (fb_papeleta_dup_dt_vcto_2 <='+#39+Inverte_Data_Plus(Trim(Data_Final.Text),'amd','/')+#39+')) Or ';
              Comando_SQL_2 := Comando_SQL_2 + '((fb_papeleta_dup_dt_vcto_3 >='+#39+Inverte_Data_Plus(Trim(Data_Inicial.Text),'amd','/')+#39+') and (fb_papeleta_dup_dt_vcto_3 <='+#39+Inverte_Data_Plus(Trim(Data_Final.Text),'amd','/')+#39+')) Or ';
              Comando_SQL_2 := Comando_SQL_2 + '((fb_papeleta_dup_dt_vcto_4 >='+#39+Inverte_Data_Plus(Trim(Data_Inicial.Text),'amd','/')+#39+') and (fb_papeleta_dup_dt_vcto_4 <='+#39+Inverte_Data_Plus(Trim(Data_Final.Text),'amd','/')+#39+'))) And ';
              Comando_SQL_2 := Comando_SQL_2 + '(((fb_papeleta_dup_dt_pgto_1 = '+#39+'0000-00-00'+#39+') Or (fb_papeleta_dup_dt_pgto_1 = '+#39+'0'+#39+') Or (fb_papeleta_dup_dt_pgto_1 = '+#39+#39+')) Or ';
              Comando_SQL_2 := Comando_SQL_2 + '((fb_papeleta_dup_dt_pgto_2 = '+#39+'0000-00-00'+#39+') Or (fb_papeleta_dup_dt_pgto_2 = '+#39+'0'+#39+') Or (fb_papeleta_dup_dt_pgto_2 = '+#39+#39+')) Or ';
              Comando_SQL_2 := Comando_SQL_2 + '((fb_papeleta_dup_dt_pgto_3 = '+#39+'0000-00-00'+#39+') Or (fb_papeleta_dup_dt_pgto_3 = '+#39+'0'+#39+') Or (fb_papeleta_dup_dt_pgto_3 = '+#39+#39+')) Or ';
              Comando_SQL_2 := Comando_SQL_2 + '((fb_papeleta_dup_dt_pgto_4 = '+#39+'0000-00-00'+#39+') Or (fb_papeleta_dup_dt_pgto_4 = '+#39+'0'+#39+') Or (fb_papeleta_dup_dt_pgto_4 = '+#39+#39+'))) ';
              Comando_SQL_2 := Comando_SQL_2 + 'And (fb_papeleta_codigo = ' +#39+ Trim(Cliente_Codigo.Text) +#39+ ') ';
              Comando_SQL_2 := Comando_SQL_2 + ' Order By fb_papeleta_numero';
     ...
     If Trim(Comando_SQL_2) <> '' Then
        ...
        ConexaoBD.SQL_FB_Papeletas.SQL.Add(Comando_SQL_2);
        ...
        If ConexaoBD.SQL_FB_Papeletas.RecordCount > 0 Then
           ...
           While Not ConexaoBD.SQL_FB_Papeletas.Eof Do
                 ...
                 ConexaoBD.SQL_Bancos.SQL.Add('Select * From fb_bancos Where fb_banco_codigo = ' + Trim(ConexaoBD.SQL_FB_Papeletasfb_papeleta_banco.Text) );
                 ...
                 DT_Vcto_1 := ConexaoBD.SQL_FB_Papeletasfb_papeleta_dup_dt_vcto_1.Text;
                 DT_Vcto_2 := ConexaoBD.SQL_FB_Papeletasfb_papeleta_dup_dt_vcto_2.Text;
                 DT_Vcto_3 := ConexaoBD.SQL_FB_Papeletasfb_papeleta_dup_dt_vcto_3.Text;
                 DT_Vcto_4 := ConexaoBD.SQL_FB_Papeletasfb_papeleta_dup_dt_vcto_4.Text;
                 ...
                 If ( Trim(DT_Vcto_1) <> '' ) Then
                    ...
                    Comando_SQL := Comando_SQL + #39 + Inverte_Data_Plus(Trim(ConexaoBD.SQL_FB_Papeletasfb_papeleta_data_emissao.Text),'amd','/') + #39 + ', ';
                    Comando_SQL := Comando_SQL + #39 + ConexaoBD.SQL_FB_Papeletasfb_papeleta_dup_nro_1.Text + #39 + ', ';
                    Comando_SQL := Comando_SQL + #39 + Inverte_Data_Plus(Trim(ConexaoBD.SQL_FB_Papeletasfb_papeleta_dup_dt_vcto_1.Text),'amd','/') + #39 + ', ';
                    Comando_SQL := Comando_SQL + #39 + Virgula_Ponto(ConexaoBD.SQL_FB_Papeletasfb_papeleta_dup_vlr_1.Text) + #39 + ', ';
                    Comando_SQL := Comando_SQL + #39 + Trim(Banco) + #39 + ',';
                    Comando_SQL := Comando_SQL + #39 + Inverte_Data_Plus(Trim(ConexaoBD.SQL_FB_Papeletasfb_papeleta_dup_dt_pgto_1.Text),'amd','/') + #39 + ', ';
                    Comando_SQL := Comando_SQL + #39 + ConexaoBD.SQL_FB_Papeletasfb_papeleta_dup_obs_1.Text + #39 + ')';
                 ...
                 If ( Trim(DT_Vcto_2) <> '' ) Then
                    ...
                    Comando_SQL := Comando_SQL + #39 + Inverte_Data_Plus(Trim(ConexaoBD.SQL_FB_Papeletasfb_papeleta_dup_dt_vcto_2.Text),'amd','/') + #39 + ', ';
                    Comando_SQL := Comando_SQL + #39 + Virgula_Ponto(ConexaoBD.SQL_FB_Papeletasfb_papeleta_dup_vlr_2.Text) + #39 + ', ';
                    Comando_SQL := Comando_SQL + #39 + Trim(Banco) + #39 + ',';
                    Comando_SQL := Comando_SQL + #39 + Inverte_Data_Plus(Trim(ConexaoBD.SQL_FB_Papeletasfb_papeleta_dup_dt_pgto_2.Text),'amd','/') + #39 + ', ';
                    Comando_SQL := Comando_SQL + #39 + ConexaoBD.SQL_FB_Papeletasfb_papeleta_dup_obs_2.Text + #39 + ')';
                 ...
                 If ( Trim(DT_Vcto_3) <> '' ) Then
                    ...
                    Comando_SQL := Comando_SQL + #39 + Inverte_Data_Plus(Trim(ConexaoBD.SQL_FB_Papeletasfb_papeleta_dup_dt_vcto_3.Text),'amd','/') + #39 + ', ';
                    Comando_SQL := Comando_SQL + #39 + Virgula_Ponto(ConexaoBD.SQL_FB_Papeletasfb_papeleta_dup_vlr_3.Text) + #39 + ', ';
                    Comando_SQL := Comando_SQL + #39 + Trim(Banco) + #39 + ',';
                    Comando_SQL := Comando_SQL + #39 + Inverte_Data_Plus(Trim(ConexaoBD.SQL_FB_Papeletasfb_papeleta_dup_dt_pgto_3.Text),'amd','/') + #39 + ', ';
                    Comando_SQL := Comando_SQL + #39 + ConexaoBD.SQL_FB_Papeletasfb_papeleta_dup_obs_3.Text + #39 + ')';
                 ...
                 If ( Trim(DT_Vcto_4) <> '' ) Then
                    ...
                    Comando_SQL := Comando_SQL + #39 + ConexaoBD.SQL_FB_Papeletasfb_papeleta_nome.Text + #39 + ', ';
                    Comando_SQL := Comando_SQL + #39 + Inverte_Data_Plus(Trim(ConexaoBD.SQL_FB_Papeletasfb_papeleta_data_emissao.Text),'amd','/') + #39 + ', ';
                    Comando_SQL := Comando_SQL + #39 + ConexaoBD.SQL_FB_Papeletasfb_papeleta_dup_nro_4.Text + #39 + ', ';
                    Comando_SQL := Comando_SQL + #39 + Inverte_Data_Plus(Trim(ConexaoBD.SQL_FB_Papeletasfb_papeleta_dup_dt_vcto_4.Text),'amd','/') + #39 + ', ';
                    Comando_SQL := Comando_SQL + #39 + Virgula_Ponto(ConexaoBD.SQL_FB_Papeletasfb_papeleta_dup_vlr_4.Text) + #39 + ', ';
                    Comando_SQL := Comando_SQL + #39 + Trim(Banco) + #39 + ',';
                    Comando_SQL := Comando_SQL + #39 + Inverte_Data_Plus(Trim(ConexaoBD.SQL_FB_Papeletasfb_papeleta_dup_dt_pgto_4.Text),'amd','/') + #39 + ', ';
                    Comando_SQL := Comando_SQL + #39 + ConexaoBD.SQL_FB_Papeletasfb_papeleta_dup_obs_4.Text + #39 + ')';
        ...
        Application.CreateForm(TContasReceberOrcamento01,ContasReceberOrcamento01);

        ContasReceberOrcamento01.QR_Periodo.Caption := MSG_Rel;

        ContasReceberOrcamento01.QR_Cobranca.Preview;
        ContasReceberOrcamento01.Destroy;
...
procedure TContasReceberOrcamento00.Opc_Data_EmissaoKeyPress(Sender: TObject;
  var Key: Char);
begin
     If Key = #13 Then
        Begin
...
procedure TContasReceberOrcamento00.Opc_Data_VenctoKeyPress(Sender: TObject;
  var Key: Char);
begin
     If Key = #13 Then
        Begin
...
procedure TContasReceberOrcamento00.Opc_Em_AbertoKeyPress(Sender: TObject;
  var Key: Char);
begin
     If Key = #13 Then
        Begin
...
procedure TContasReceberOrcamento00.Numero_DoctoKeyPress(Sender: TObject;
  var Key: Char);
begin
     If Key = #13 Then
        Begin
...
procedure TContasReceberOrcamento00.Dados_ProcuraKeyPress(Sender: TObject;
  var Key: Char);
begin
     If Key = #13 Then
        Begin
...
procedure TContasReceberOrcamento00.Opcoes_ProcuraKeyPress(Sender: TObject;
  var Key: Char);
begin
     If Key = #13 Then
        Begin
...
procedure TContasReceberOrcamento00.Data_InicialKeyPress(Sender: TObject;
  var Key: Char);
begin
     If Key = #13 Then
        Begin
...
procedure TContasReceberOrcamento00.Data_FinalKeyPress(Sender: TObject;
  var Key: Char);
begin
     If Key = #13 Then
        Begin
