unit Registro_Notas_Fiscais_Saidas_02;
...
type
  TRegistroNotasFiscaisSaidas02 = class(TForm)
    Panel3: TPanel;
    BT_Incluir: TBitBtn;
    BT_Sair: TBitBtn;
    Panel1: TPanel;
    ...
    procedure Zera_Base_ICMSClick(Sender: TObject);
...
var
  RegistroNotasFiscaisSaidas02: TRegistroNotasFiscaisSaidas02;
...
function TRegistroNotasFiscaisSaidas02.ConversaoRecursiva(N: LongWord): string;
begin
     case N of
...
function TRegistroNotasFiscaisSaidas02.Extenso(parmNumero: Real): string;
begin
...
function TRegistroNotasFiscaisSaidas02.Letra_Maiuscula(Texto: String): string;
...
function TRegistroNotasFiscaisSaidas02.Prepara_Volume(Posicao_Inicial, Posicao_Final: Integer): string;
...
function TRegistroNotasFiscaisSaidas02.Valida_Dados(): Boolean;
...
begin
     ...
     Else
        ...
        If Trim(Programa_Anterior.Text) = '' Then
           ...
           ConexaoBD.SQL_MB_Nota_Fiscal.SQL.Add('Select * from mb_notas_fiscais Where mb_nota_fiscal_numero = ' + Trim(Nota_Numero.Text) + ' Order By mb_nota_fiscal_data_emissao Desc');
...
procedure TRegistroNotasFiscaisSaidas02.Carrega_Transportadoras();
begin
     Ampulheta();
...
procedure TRegistroNotasFiscaisSaidas02.Carrega_Pgto_Frete();
begin
...
procedure TRegistroNotasFiscaisSaidas02.BT_SairClick(Sender: TObject);
begin
     RegistroNotasFiscaisSaidas02.Close;
end;

procedure TRegistroNotasFiscaisSaidas02.BT_ProcurarClick(Sender: TObject);
begin
     Ampulheta();
     Application.CreateForm(TClientes00,Clientes00);

     Clientes00.Programa_Anterior.Text := 'Registro-Notas-Inclusão-MB';
...
procedure TRegistroNotasFiscaisSaidas02.Nota_NumeroKeyPress(Sender: TObject;
  var Key: Char);
begin
...
procedure TRegistroNotasFiscaisSaidas02.Nota_EmissaoKeyPress(Sender: TObject;
  var Key: Char);
begin
     If Key = #13 Then
        Begin
...
procedure TRegistroNotasFiscaisSaidas02.Nota_EntradaKeyPress(Sender: TObject;
  var Key: Char);
begin
     If Key = #13 Then
        Begin
...
procedure TRegistroNotasFiscaisSaidas02.Nota_RecebimentoKeyPress(Sender: TObject;
  var Key: Char);
begin
     If Key = #13 Then
        Begin
...
procedure TRegistroNotasFiscaisSaidas02.Cliente_CFOPKeyPress(Sender: TObject;
  var Key: Char);
begin
     If Key = #13 Then
        Begin
...
procedure TRegistroNotasFiscaisSaidas02.Nota_NaturezaKeyPress(Sender: TObject;
  var Key: Char);
begin
     If Key = #13 Then
        Begin
...
procedure TRegistroNotasFiscaisSaidas02.Nota_Condicao_Pgto_1KeyPress(
...
procedure TRegistroNotasFiscaisSaidas02.Nota_Condicao_Pgto_2KeyPress(
  Sender: TObject; var Key: Char);
begin
     So_Numero(Sender,Key);
...
procedure TRegistroNotasFiscaisSaidas02.Nota_Condicao_Pgto_3KeyPress(
  Sender: TObject; var Key: Char);
begin
     So_Numero(Sender,Key);
...
procedure TRegistroNotasFiscaisSaidas02.Nota_Condicao_Pgto_4KeyPress(
  Sender: TObject; var Key: Char);
begin
     So_Numero(Sender,Key);
...
procedure TRegistroNotasFiscaisSaidas02.Nota_Aliquota_ISSKeyPress(
  Sender: TObject; var Key: Char);
begin
     So_Valor(Sender,Key);
...
procedure TRegistroNotasFiscaisSaidas02.Nota_Valor_ISSKeyPress(Sender: TObject;
  var Key: Char);
begin
     So_Valor(Sender,Key);
...
procedure TRegistroNotasFiscaisSaidas02.Nota_Valor_ServicosKeyPress(
  Sender: TObject; var Key: Char);
begin
     So_Valor(Sender,Key);
...
procedure TRegistroNotasFiscaisSaidas02.Nota_Base_ICMSKeyPress(Sender: TObject;
  var Key: Char);
begin
     So_Valor(Sender,Key);
...
procedure TRegistroNotasFiscaisSaidas02.Nota_Valor_ICMSKeyPress(Sender: TObject;
  var Key: Char);
begin
     So_Valor(Sender,Key);
...
procedure TRegistroNotasFiscaisSaidas02.Nota_Base_ICMS_SubKeyPress(
  Sender: TObject; var Key: Char);
begin
     So_Valor(Sender,Key);
...
procedure TRegistroNotasFiscaisSaidas02.Nota_Valor_ICMS_SubKeyPress(
  Sender: TObject; var Key: Char);
begin
     So_Valor(Sender,Key);
...
procedure TRegistroNotasFiscaisSaidas02.Nota_Valor_ProdutoKeyPress(
  Sender: TObject; var Key: Char);
begin
     So_Valor(Sender,Key);
...
procedure TRegistroNotasFiscaisSaidas02.Valor_FreteKeyPress(Sender: TObject;
  var Key: Char);
begin
     So_Valor(Sender,Key);
...
procedure TRegistroNotasFiscaisSaidas02.Nota_Valor_SeguroKeyPress(
  Sender: TObject; var Key: Char);
begin
     So_Valor(Sender,Key);
...
procedure TRegistroNotasFiscaisSaidas02.Nota_Outras_DespesasKeyPress(
  Sender: TObject; var Key: Char);
begin
     So_Valor(Sender,Key);
...
procedure TRegistroNotasFiscaisSaidas02.Valor_IPIKeyPress(Sender: TObject;
  var Key: Char);
begin
     So_Valor(Sender,Key);
...
procedure TRegistroNotasFiscaisSaidas02.Valor_TotalKeyPress(Sender: TObject;
  var Key: Char);
begin
     So_Valor(Sender,Key);
...
procedure TRegistroNotasFiscaisSaidas02.Transportadora_CNPJKeyPress(
  Sender: TObject; var Key: Char);
begin
     If Key = #13 Then
        Begin
...
procedure TRegistroNotasFiscaisSaidas02.Transportadora_NomeKeyPress(
  Sender: TObject; var Key: Char);
begin
     If Key = #13 Then
        Begin
...
procedure TRegistroNotasFiscaisSaidas02.Nota_Pgto_FreteKeyPress(Sender: TObject;
  var Key: Char);
begin
     If Key = #13 Then
        Begin
...
procedure TRegistroNotasFiscaisSaidas02.Qtde_VolumeKeyPress(Sender: TObject;
  var Key: Char);
begin
     So_Numero(Sender,Key);
...
procedure TRegistroNotasFiscaisSaidas02.EspecieKeyPress(Sender: TObject;
  var Key: Char);
begin
     If Key = #13 Then
        Begin
...
procedure TRegistroNotasFiscaisSaidas02.MarcaKeyPress(Sender: TObject;
  var Key: Char);
begin
     If Key = #13 Then
        Begin
...
procedure TRegistroNotasFiscaisSaidas02.Peso_BrutoKeyPress(Sender: TObject;
  var Key: Char);
begin
     So_Valor(Sender,Key);
...
procedure TRegistroNotasFiscaisSaidas02.Peso_LiquidoKeyPress(
  Sender: TObject; var Key: Char);
begin
     So_Valor(Sender,Key);
...
procedure TRegistroNotasFiscaisSaidas02.Nota_ObsKeyPress(Sender: TObject;
  var Key: Char);
begin
     If Key = #13 Then
        Begin
...
procedure TRegistroNotasFiscaisSaidas02.Exibe_Grid_Produtos();
...
begin
     ...
     If Trim(Programa_Anterior.Text) = 'Alteração-Exclusão' Then
        ...
        ConexaoBD.SQL_MB_Nota_Fiscal_Produto.SQL.Add('Select * from mb_notas_fiscais_produtos Where mb_nota_fiscal_produto_numero = ' + Trim(Nota_Numero.Text) + ' Order By mb_nota_fiscal_produto_posicao');
        ...
        If ConexaoBD.SQL_MB_Nota_Fiscal_Produto.RecordCount > 0 Then
           ...
           SGD_Produtos.RowCount  := (ConexaoBD.SQL_MB_Nota_Fiscal_Produto.RecordCount + 2);
           ...
           While Not ConexaoBD.SQL_MB_Nota_Fiscal_Produto.Eof Do
                 ...
                 SGD_Produtos.Cells[1,Ind]  := ConexaoBD.SQL_MB_Nota_Fiscal_Produtomb_nota_fiscal_produto_qtde.Text;
                 SGD_Produtos.Cells[2,Ind]  := ConexaoBD.SQL_MB_Nota_Fiscal_Produtomb_nota_fiscal_produto_codigo.Text;
                 SGD_Produtos.Cells[4,Ind]  := ConexaoBD.SQL_MB_Nota_Fiscal_Produtomb_nota_fiscal_produto_desc.Text;
                 SGD_Produtos.Cells[5,Ind]  := IntToStr(ConexaoBD.SQL_MB_Nota_Fiscal_Produtomb_nota_fiscal_produto_lote.AsInteger);
                 SGD_Produtos.Cells[13,Ind] := DBG_NF_FB_Faturados_Produto_Descricao_Detalhada.Text;

                 //*** Busca o Peso do Produto ***

                 If Trim(ConexaoBD.SQL_MB_Nota_Fiscal_Produtomb_nota_fiscal_produto_codigo.Text) <> '' Then
                    Begin
                    ConexaoBD.SQL_Produtos.Close;
                    ConexaoBD.SQL_Produtos.SQL.Clear;
                    ConexaoBD.SQL_Produtos.SQL.Add('Select * from fb_produtos Where fb_produto_codigo = ' +#39+ Trim(ConexaoBD.SQL_MB_Nota_Fiscal_Produtomb_nota_fiscal_produto_codigo.Text) + #39);
                    ...
                    If Not ConexaoBD.SQL_Produtos.Eof Then
                       ...
                       Peso  := Peso + ((ConexaoBD.SQL_Produtosfb_produto_peso.AsVariant) * (StrToFloat(Ponto_Virgula(ConexaoBD.SQL_MB_Nota_Fiscal_Produtomb_nota_fiscal_produto_qtde.Text)) ));

                       //*** Retorna ao Carregamento Normal ***

                       Vlr_Exibicao := Trim(Virgula_Ponto(ConexaoBD.SQL_MB_Nota_Fiscal_Produtomb_nota_fiscal_produto_vlr_uni.Text));
                       ...
                       Vlr_Exibicao := Trim(Virgula_Ponto(ConexaoBD.SQL_MB_Nota_Fiscal_Produtomb_nota_fiscal_produto_vlr_tot.Text));
                       Val(Vlr_Exibicao,Vlr_Numero,Erro);
                       Str(Vlr_Numero:13:2,Vlr_Exibicao);
                       Vlr_Exibicao := Ponto_Virgula(Trim(Vlr_Exibicao));
                       ...
                       Else
                          Begin
                          SGD_Produtos.Cells[8,Ind]  := ConexaoBD.SQL_MB_Nota_Fiscal_Produtomb_nota_fiscal_produto_vlr_ipi.Text;
                       End;
                       SGD_Produtos.Cells[9,Ind]  := ConexaoBD.SQL_MB_Nota_Fiscal_Produtomb_nota_fiscal_produto_posicao.Text;
                    ...
                    Else
                       ...
                       Peso  := Peso + ((0) * (StrToFloat(Ponto_Virgula(ConexaoBD.SQL_MB_Nota_Fiscal_Produtomb_nota_fiscal_produto_qtde.Text)) ));
...
procedure TRegistroNotasFiscaisSaidas02.FormShow(Sender: TObject);
begin
     If Trim(Programa_Anterior.Text) = '' Then
        Begin
...
procedure TRegistroNotasFiscaisSaidas02.Nota_Base_ICMSExit(Sender: TObject);
begin
...
procedure TRegistroNotasFiscaisSaidas02.Nota_Valor_ICMSExit(Sender: TObject);
begin
...
procedure TRegistroNotasFiscaisSaidas02.Nota_Base_ICMS_SubExit(Sender: TObject);
begin
...
procedure TRegistroNotasFiscaisSaidas02.Nota_Valor_ICMS_SubExit(Sender: TObject);
begin
...
procedure TRegistroNotasFiscaisSaidas02.Nota_Valor_ProdutoExit(Sender: TObject);
begin
...
procedure TRegistroNotasFiscaisSaidas02.Valor_FreteExit(Sender: TObject);
begin
...
procedure TRegistroNotasFiscaisSaidas02.Nota_Valor_SeguroExit(Sender: TObject);
begin
...
procedure TRegistroNotasFiscaisSaidas02.Nota_Outras_DespesasExit(
  Sender: TObject);
begin
...
procedure TRegistroNotasFiscaisSaidas02.Valor_IPIExit(Sender: TObject);
begin
...
procedure TRegistroNotasFiscaisSaidas02.Valor_TotalExit(Sender: TObject);
begin
...
procedure TRegistroNotasFiscaisSaidas02.Qtde_VolumeExit(Sender: TObject);
begin
...
procedure TRegistroNotasFiscaisSaidas02.Peso_BrutoExit(Sender: TObject);
begin
...
procedure TRegistroNotasFiscaisSaidas02.Peso_LiquidoExit(Sender: TObject);
begin
...
procedure TRegistroNotasFiscaisSaidas02.BT_AdicionarClick(Sender: TObject);
begin
     If Trim(Cliente_Codigo.Text) <> '' Then
        Begin
        Ampulheta();
        ...
        AdicionaProdutoRelacao.Programa_Anterior.Text    := 'Registro-Notas-Inclusão-MB';
...
procedure TRegistroNotasFiscaisSaidas02.SGD_ProdutosDblClick(Sender: TObject);
begin
     ...
     AdicionaQtdeProduto.Programa_Anterior.Text       := 'Registro-Notas-Inclusão-MB';
...
procedure TRegistroNotasFiscaisSaidas02.BT_IncluirClick(Sender: TObject);
...
begin
     If Valida_Dados() Then
        ...
        If (Imprime_Nota_Apos.Checked = True) And (Trim(Tipo_Nota_Emissao.Text) = 'NFe') Then
           ...
           Comando_SQL := Comando_SQL + 'mb_nf_anterior_data = ' +#39+ Trim(Inverte_Data_Plus(Nota_Emissao.Text,'amd','/')) +#39+ ', ';
           Comando_SQL := Comando_SQL + 'mb_nf_anterior_numero = ' + Trim(Nota_Numero.Text);
...
procedure TRegistroNotasFiscaisSaidas02.FormClose(Sender: TObject;
...
begin
     ...
     If Trim(RegistroNotasFiscaisSaidas00.Numero_Nota.Text) <> '' Then
        Begin
        ConexaoBD.SQL_MB_Nota_Fiscal.SQL.Add('Select * from mb_notas_fiscais Where mb_nota_fiscal_numero = ' + Trim(RegistroNotasFiscaisSaidas00.Numero_Nota.Text) + ' Order By mb_nota_fiscal_data_emissao Desc, mb_nota_fiscal_numero Desc');
        End
     Else
        Begin
        ConexaoBD.SQL_MB_Nota_Fiscal.SQL.Add('Select * from mb_notas_fiscais Where (mb_nota_fiscal_data_emissao >='+#39+Inverte_Data_Plus(Trim(RegistroNotasFiscaisSaidas00.Data_Inicial.Text),'amd','/')+#39+' and mb_nota_fiscal_data_emissao <='+#39+Inverte_Data_Plus(Trim(RegistroNotasFiscaisSaidas00.Data_Final.Text),'amd','/')+#39+') Order By mb_nota_fiscal_data_emissao Desc, mb_nota_fiscal_numero Desc');
     End;

     ConexaoBD.SQL_MB_Nota_Fiscal.Open;

     RegistroNotasFiscaisSaidas00.Total_Pedidos_Ibrasmak.Caption := IntToStr(ConexaoBD.SQL_MB_Nota_Fiscal.RecordCount);
     ...
     Action := caFree;
     Release;
     RegistroNotasFiscaisSaidas02 := Nil;
end;

procedure TRegistroNotasFiscaisSaidas02.Cliente_DescontoExit(
  Sender: TObject);
begin
...
procedure TRegistroNotasFiscaisSaidas02.Cliente_DescontoKeyPress(
  Sender: TObject; var Key: Char);
begin
     So_Valor(Sender,Key);
...
procedure TRegistroNotasFiscaisSaidas02.Cliente_Condicao_Pgto_1KeyPress(
  Sender: TObject; var Key: Char);
begin
     If Key = #13 Then
        Begin
...
procedure TRegistroNotasFiscaisSaidas02.Cliente_Condicao_Pgto_2KeyPress(
  Sender: TObject; var Key: Char);
begin
     If Key = #13 Then
        Begin
...
procedure TRegistroNotasFiscaisSaidas02.Cliente_Condicao_Pgto_3KeyPress(
  Sender: TObject; var Key: Char);
begin
     If Key = #13 Then
        Begin
...
procedure TRegistroNotasFiscaisSaidas02.Cliente_Condicao_Pgto_4KeyPress(
  Sender: TObject; var Key: Char);
begin
     If Key = #13 Then
        Begin
...
procedure TRegistroNotasFiscaisSaidas02.Natureza_OperacaoKeyPress(
  Sender: TObject; var Key: Char);
begin
     If Key = #13 Then
        Begin
...
procedure TRegistroNotasFiscaisSaidas02.Cliente_Natureza_OperacaoKeyPress(
  Sender: TObject; var Key: Char);
begin
     If Key = #13 Then
        Begin
...
procedure TRegistroNotasFiscaisSaidas02.Tipo_Nota_SaidaKeyPress(
  Sender: TObject; var Key: Char);
begin
     If Key = #13 Then
        Begin
...
procedure TRegistroNotasFiscaisSaidas02.Tipo_Nota_EntradaKeyPress(
  Sender: TObject; var Key: Char);
begin
     If Key = #13 Then
        Begin
...
procedure TRegistroNotasFiscaisSaidas02.Cliente_Tipo_TransporteKeyPress(
  Sender: TObject; var Key: Char);
begin
     If Key = #13 Then
        Begin
...
procedure TRegistroNotasFiscaisSaidas02.Cliente_Pgto_FreteKeyPress(
  Sender: TObject; var Key: Char);
begin
     If Key = #13 Then
        Begin
...
procedure TRegistroNotasFiscaisSaidas02.Cliente_TransportadoraKeyPress(
  Sender: TObject; var Key: Char);
begin
     If Key = #13 Then
        Begin
...
procedure TRegistroNotasFiscaisSaidas02.Cliente_Emite_LoteKeyPress(
  Sender: TObject; var Key: Char);
begin
     If Key = #13 Then
        Begin
...
procedure TRegistroNotasFiscaisSaidas02.Cliente_Aliquota_ICMSKeyPress(
  Sender: TObject; var Key: Char);
begin
     So_Valor(Sender,Key);
...
procedure TRegistroNotasFiscaisSaidas02.Cliente_Aliquota_ICMSExit(
  Sender: TObject);
begin
...
procedure TRegistroNotasFiscaisSaidas02.Cliente_Base_ReduzidaExit(
  Sender: TObject);
begin
...
procedure TRegistroNotasFiscaisSaidas02.Cliente_Base_ReduzidaKeyPress(
  Sender: TObject; var Key: Char);
begin
     So_Valor(Sender,Key);
...
procedure TRegistroNotasFiscaisSaidas02.Cliente_Ordem_CompraKeyPress(
  Sender: TObject; var Key: Char);
begin
     If Key = #13 Then
        Begin
...
procedure TRegistroNotasFiscaisSaidas02.Natureza_OperacaoChange(
  Sender: TObject);
var
  Nro_Natureza : string;
...
procedure TRegistroNotasFiscaisSaidas02.SGD_ProdutosKeyPress(
  Sender: TObject; var Key: Char);
begin
  If Key = #13 Then
     Begin
      If Trim(Cliente_Codigo.Text) <> '' Then
        ...
        If (Trim(SGD_Produtos.Cells[1, SGD_Produtos.Row]) <> '') Then
           ...
           CodigoProdutoNotaCliente00.Programa_Anterior.Text       := 'Registro-Notas-Inclusão-MB';
...
procedure TRegistroNotasFiscaisSaidas02.Totaliza_Pedido();
...
procedure TRegistroNotasFiscaisSaidas02.Prepara_Condicao();
...
procedure TRegistroNotasFiscaisSaidas02.Cliente_Condicao_Pgto_Vlr_1KeyPress(
  Sender: TObject; var Key: Char);
begin
     So_Valor(Sender,Key);
...
procedure TRegistroNotasFiscaisSaidas02.Cliente_Condicao_Pgto_Vlr_2KeyPress(
  Sender: TObject; var Key: Char);
begin
     So_Valor(Sender,Key);
...
procedure TRegistroNotasFiscaisSaidas02.Cliente_Condicao_Pgto_Vlr_3KeyPress(
  Sender: TObject; var Key: Char);
begin
     So_Valor(Sender,Key);
...
procedure TRegistroNotasFiscaisSaidas02.Cliente_Condicao_Pgto_Vlr_4KeyPress(
  Sender: TObject; var Key: Char);
begin
     So_Valor(Sender,Key);
...
procedure TRegistroNotasFiscaisSaidas02.Cliente_Condicao_Pgto_Vlr_1Exit(
  Sender: TObject);
begin
...
procedure TRegistroNotasFiscaisSaidas02.Cliente_Condicao_Pgto_Vlr_2Exit(
  Sender: TObject);
begin
...
procedure TRegistroNotasFiscaisSaidas02.Cliente_Condicao_Pgto_Vlr_3Exit(
  Sender: TObject);
begin
...
procedure TRegistroNotasFiscaisSaidas02.Cliente_Condicao_Pgto_Vlr_4Exit(
  Sender: TObject);
begin
...
procedure TRegistroNotasFiscaisSaidas02.BT_Adicionar_ForaClick(
  Sender: TObject);
begin
     If Trim(Cliente_Codigo.Text) <> '' Then
        Begin
        ...
        AdicionaQtdeProduto02.Programa_Anterior.Text          := 'Registro-Notas-Inclusão-MB';
...
procedure TRegistroNotasFiscaisSaidas02.Imprime_Nota();
     ...
     If Posicao_Nota_Boleto > 0 Then
        ...
        For Nro_Nota_Boleto_INI := (StrToInt(Nota_Numero.Text) - Posicao_Nota_Boleto) To Nro_Nota_Boleto_FIM Do
            ...
            If ConexaoBD.SQL_MB_Nota_Fiscal.RecordCount > 0 Then
               ...
               Boleto_Docto_5 := Boleto_Docto_5 + ' / ' + ConexaoBD.SQL_MB_Nota_Fiscalmb_nota_fiscal_dup_nro_5.Text;
               Boleto_Docto_6 := Boleto_Docto_6 + ' / ' + ConexaoBD.SQL_MB_Nota_Fiscalmb_nota_fiscal_dup_nro_6.Text;
               Boleto_Docto_7 := Boleto_Docto_7 + ' / ' + ConexaoBD.SQL_MB_Nota_Fiscalmb_nota_fiscal_dup_nro_7.Text;
               Boleto_Docto_8 := Boleto_Docto_8 + ' / ' + ConexaoBD.SQL_MB_Nota_Fiscalmb_nota_fiscal_dup_nro_8.Text;
               Boleto_Docto_9 := Boleto_Docto_9 + ' / ' + ConexaoBD.SQL_MB_Nota_Fiscalmb_nota_fiscal_dup_nro_9.Text;
               Boleto_Docto_10 := Boleto_Docto_10 + ' / ' + ConexaoBD.SQL_MB_Nota_Fiscalmb_nota_fiscal_dup_nro_10.Text;
               Boleto_Docto_11 := Boleto_Docto_11 + ' / ' + ConexaoBD.SQL_MB_Nota_Fiscalmb_nota_fiscal_dup_nro_11.Text;
               Boleto_Docto_12 := Boleto_Docto_12 + ' / ' + ConexaoBD.SQL_MB_Nota_Fiscalmb_nota_fiscal_dup_nro_12.Text;
               Boleto_Docto_13 := Boleto_Docto_13 + ' / ' + ConexaoBD.SQL_MB_Nota_Fiscalmb_nota_fiscal_dup_nro_13.Text;
               Boleto_Docto_14 := Boleto_Docto_14 + ' / ' + ConexaoBD.SQL_MB_Nota_Fiscalmb_nota_fiscal_dup_nro_14.Text;
               Boleto_Docto_15 := Boleto_Docto_15 + ' / ' + ConexaoBD.SQL_MB_Nota_Fiscalmb_nota_fiscal_dup_nro_15.Text;
               Boleto_Docto_16 := Boleto_Docto_16 + ' / ' + ConexaoBD.SQL_MB_Nota_Fiscalmb_nota_fiscal_dup_nro_16.Text;
               Boleto_Docto_17 := Boleto_Docto_17 + ' / ' + ConexaoBD.SQL_MB_Nota_Fiscalmb_nota_fiscal_dup_nro_17.Text;
               Boleto_Docto_18 := Boleto_Docto_18 + ' / ' + ConexaoBD.SQL_MB_Nota_Fiscalmb_nota_fiscal_dup_nro_18.Text;
               Boleto_Docto_19 := Boleto_Docto_19 + ' / ' + ConexaoBD.SQL_MB_Nota_Fiscalmb_nota_fiscal_dup_nro_19.Text;
               Boleto_Docto_20 := Boleto_Docto_20 + ' / ' + ConexaoBD.SQL_MB_Nota_Fiscalmb_nota_fiscal_dup_nro_20.Text;
               Boleto_Docto_21 := Boleto_Docto_21 + ' / ' + ConexaoBD.SQL_MB_Nota_Fiscalmb_nota_fiscal_dup_nro_21.Text;
               Boleto_Docto_22 := Boleto_Docto_22 + ' / ' + ConexaoBD.SQL_MB_Nota_Fiscalmb_nota_fiscal_dup_nro_22.Text;
               Boleto_Docto_23 := Boleto_Docto_23 + ' / ' + ConexaoBD.SQL_MB_Nota_Fiscalmb_nota_fiscal_dup_nro_23.Text;
               Boleto_Docto_24 := Boleto_Docto_24 + ' / ' + ConexaoBD.SQL_MB_Nota_Fiscalmb_nota_fiscal_dup_nro_24.Text;
               ...
               Vlr_Nota_Boleto_5 := Vlr_Nota_Boleto_4 + ConexaoBD.SQL_MB_Nota_Fiscalmb_nota_fiscal_dup_vlr_5.AsFloat;
               Vlr_Nota_Boleto_6 := Vlr_Nota_Boleto_4 + ConexaoBD.SQL_MB_Nota_Fiscalmb_nota_fiscal_dup_vlr_6.AsFloat;
               Vlr_Nota_Boleto_7 := Vlr_Nota_Boleto_4 + ConexaoBD.SQL_MB_Nota_Fiscalmb_nota_fiscal_dup_vlr_7.AsFloat;
               Vlr_Nota_Boleto_8 := Vlr_Nota_Boleto_4 + ConexaoBD.SQL_MB_Nota_Fiscalmb_nota_fiscal_dup_vlr_8.AsFloat;
               Vlr_Nota_Boleto_9 := Vlr_Nota_Boleto_4 + ConexaoBD.SQL_MB_Nota_Fiscalmb_nota_fiscal_dup_vlr_9.AsFloat;
               Vlr_Nota_Boleto_10 := Vlr_Nota_Boleto_4 + ConexaoBD.SQL_MB_Nota_Fiscalmb_nota_fiscal_dup_vlr_10.AsFloat;
               Vlr_Nota_Boleto_11 := Vlr_Nota_Boleto_4 + ConexaoBD.SQL_MB_Nota_Fiscalmb_nota_fiscal_dup_vlr_11.AsFloat;
               Vlr_Nota_Boleto_12 := Vlr_Nota_Boleto_4 + ConexaoBD.SQL_MB_Nota_Fiscalmb_nota_fiscal_dup_vlr_12.AsFloat;
               Vlr_Nota_Boleto_13 := Vlr_Nota_Boleto_4 + ConexaoBD.SQL_MB_Nota_Fiscalmb_nota_fiscal_dup_vlr_13.AsFloat;
               Vlr_Nota_Boleto_14 := Vlr_Nota_Boleto_4 + ConexaoBD.SQL_MB_Nota_Fiscalmb_nota_fiscal_dup_vlr_14.AsFloat;
               Vlr_Nota_Boleto_15 := Vlr_Nota_Boleto_4 + ConexaoBD.SQL_MB_Nota_Fiscalmb_nota_fiscal_dup_vlr_15.AsFloat;
               Vlr_Nota_Boleto_16 := Vlr_Nota_Boleto_4 + ConexaoBD.SQL_MB_Nota_Fiscalmb_nota_fiscal_dup_vlr_16.AsFloat;
               Vlr_Nota_Boleto_17 := Vlr_Nota_Boleto_4 + ConexaoBD.SQL_MB_Nota_Fiscalmb_nota_fiscal_dup_vlr_17.AsFloat;
               Vlr_Nota_Boleto_18 := Vlr_Nota_Boleto_4 + ConexaoBD.SQL_MB_Nota_Fiscalmb_nota_fiscal_dup_vlr_18.AsFloat;
               Vlr_Nota_Boleto_19 := Vlr_Nota_Boleto_4 + ConexaoBD.SQL_MB_Nota_Fiscalmb_nota_fiscal_dup_vlr_19.AsFloat;
               Vlr_Nota_Boleto_20 := Vlr_Nota_Boleto_4 + ConexaoBD.SQL_MB_Nota_Fiscalmb_nota_fiscal_dup_vlr_20.AsFloat;
               Vlr_Nota_Boleto_21 := Vlr_Nota_Boleto_4 + ConexaoBD.SQL_MB_Nota_Fiscalmb_nota_fiscal_dup_vlr_21.AsFloat;
               Vlr_Nota_Boleto_22 := Vlr_Nota_Boleto_4 + ConexaoBD.SQL_MB_Nota_Fiscalmb_nota_fiscal_dup_vlr_22.AsFloat;
               Vlr_Nota_Boleto_23 := Vlr_Nota_Boleto_4 + ConexaoBD.SQL_MB_Nota_Fiscalmb_nota_fiscal_dup_vlr_23.AsFloat;
               Vlr_Nota_Boleto_24 := Vlr_Nota_Boleto_4 + ConexaoBD.SQL_MB_Nota_Fiscalmb_nota_fiscal_dup_vlr_24.AsFloat;
...
procedure TRegistroNotasFiscaisSaidas02.Imprime_Nota_Ibrasmak(Posicao_Inicial, Posicao_Final: Integer);
...
begin
     ...
     Else
        Begin
        Vlr_Total_Produtos := (Total_Nota + Vlr_Frete);
     End;
     ...
     Linha := Linha + 3;
     Imprimir.PoeStr(Linha,120, Exibe_Nro_Impressao(Trim(Nota_Numero.Text),7));
...
procedure TRegistroNotasFiscaisSaidas02.Grava_Nota_Ibrasmak(Posicao_Inicial, Posicao_Final: Integer);
...
begin
     ...
     Comando_SQL := Comando_SQL + 'mb_nota_fiscal_icms_reduzida, ';
     Comando_SQL := Comando_SQL + 'mb_nota_fiscal_tipo_nota, ';
     Comando_SQL := Comando_SQL + 'mb_nota_fiscal_consumo, ';
     Comando_SQL := Comando_SQL + 'mb_nota_fiscal_zerar_icms, ';
     Comando_SQL := Comando_SQL + 'mb_nota_fiscal_total_nf_ipi, ';
     ...
     Comando_SQL := Comando_SQL + 'mb_nota_fiscal_base_icms_sub, ';
     Comando_SQL := Comando_SQL + 'mb_nota_fiscal_valor_icms_sub, ';
     Comando_SQL := Comando_SQL + 'mb_nota_fiscal_valor_seguro, ';
     Comando_SQL := Comando_SQL + 'mb_nota_fiscal_outras_despesas, ';
     Comando_SQL := Comando_SQL + 'mb_nota_fiscal_aliquota_icms, ';
     Comando_SQL := Comando_SQL + 'faturado_base_icms, ';
     Comando_SQL := Comando_SQL + 'mb_nota_fiscal_nao_possui_duplicatas) ';
...
procedure TRegistroNotasFiscaisSaidas02.BT_ExcluirClick(Sender: TObject);
begin
     If Confirma('Confirma a Exclusão desta Nota-Fiscal?') = 6 Then
        ...
        ConexaoBD.SQL_Comunitario.SQL.Clear;
        ConexaoBD.SQL_Comunitario.SQL.Add('Delete from mb_notas_fiscais Where mb_nota_fiscal_numero = ' +  Trim(Nota_Numero.Text));
        ConexaoBD.SQL_Comunitario.ExecSQL;

        //*** Deleta os Itens do Pedido Principal ***

        ConexaoBD.SQL_Comunitario.SQL.Clear;
        ConexaoBD.SQL_Comunitario.SQL.Add('Delete from mb_notas_fiscais_produtos Where mb_nota_fiscal_produto_numero = ' +  Trim(Nota_Numero.Text));
        ConexaoBD.SQL_Comunitario.ExecSQL;
...
procedure TRegistroNotasFiscaisSaidas02.BT_AlterarClick(Sender: TObject);
...
procedure TRegistroNotasFiscaisSaidas02.BT_Procurar_FornecedoresClick(
  Sender: TObject);
begin
    Ampulheta();
    Application.CreateForm(TFornecedor00,Fornecedor00);

    Fornecedor00.Programa_Anterior.Text := 'Registro-Notas-Inclusão-MB';
...
procedure TRegistroNotasFiscaisSaidas02.Totaliza_Nota(Posicao_Inicial, Posicao_Final: Integer);
...
procedure TRegistroNotasFiscaisSaidas02.BT_CalcularClick(Sender: TObject);
begin
     Totaliza_Nota(1,(SGD_Produtos.RowCount - 1));
end;

procedure TRegistroNotasFiscaisSaidas02.Opcao_Sem_DuplicataClick(
  Sender: TObject);
begin
...
procedure TRegistroNotasFiscaisSaidas02.Imprime_Nota_AposClick(
  Sender: TObject);
begin
     Imprimir.ArqDestino := 'C:\Ibrasmak\NF_Tela.TXT';
     Imprimir.Acentuacao := acNenhum;
...
procedure TRegistroNotasFiscaisSaidas02.Imprime_Nota_TelaClick(
  Sender: TObject);
begin
       Imprimir.ArqDestino := 'C:\Ibrasmak\NF_Tela.TXT';
       Imprimir.Acentuacao := acNenhum;
...
procedure TRegistroNotasFiscaisSaidas02.Zera_Base_ICMSClick(
  Sender: TObject);
begin
     If Zera_Base_ICMS.Checked Then
        Begin
