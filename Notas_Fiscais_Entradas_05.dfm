object NotasFiscaisEntradas05: TNotasFiscaisEntradas05
  Left = 192
  Top = 103
  BorderIcons = [biSystemMenu, biMinimize]
  BorderStyle = bsSingle
  Caption = 'Adiciona Vencimentos - Nota de Entrada'
  ClientHeight = 126
  ClientWidth = 389
  Color = clBtnFace
  ...
  object Panel1: TPanel
    ...
    object GroupBox1: TGroupBox
      ...
      object Adiciona_Vencimento: TMaskEdit
        Left = 210
        Top = 32
        Width = 65
        Height = 19
        ...
        TabOrder = 1
        Text = '  /  /    '
        OnKeyPress = Adiciona_VencimentoKeyPress
      end
    end
  end
