unit Historicos_Notas_Fiscais_Entradas_01;
...
type
  THistoricosNotasFiscaisEntradas01 = class(TForm)
    Panel3: TPanel;
    BT_Sair: TBitBtn;
    ...
    Nota_Condicao_Pgto_2: TEdit;
    Nota_Condicao_Pgto_3: TEdit;
    Nota_Condicao_Pgto_4: TEdit;
    ...
    procedure Nota_Condicao_Pgto_2Exit(Sender: TObject);
    procedure Nota_Condicao_Pgto_3Exit(Sender: TObject);
    procedure Nota_Condicao_Pgto_4Exit(Sender: TObject);
...
var
  HistoricosNotasFiscaisEntradas01: THistoricosNotasFiscaisEntradas01;
...
uses Conexao_BD, Rotinas_Gerais, Notas_Fiscais_Entradas_03,
  ...
  Notas_Fiscais_Entradas_00, Notas_Fiscais_Entradas_02;
...
function THistoricosNotasFiscaisEntradas01.Valida_Dados(): Boolean;
...
procedure THistoricosNotasFiscaisEntradas01.BT_SairClick(Sender: TObject);
begin
     HistoricosNotasFiscaisEntradas01.Close;
end;

procedure THistoricosNotasFiscaisEntradas01.FormShow(Sender: TObject);
begin
     If Trim(Posicao_Nota.Text) <> '' Then
        ...
        If ConexaoBD.SQL_FB_Notas_Entradas.RecordCount > 0 Then
           ...
           Nota_Condicao_Pgto_2.Text        := ConexaoBD.SQL_FB_Notas_Entradasfb_nota_entrada_cond_pgto_2.Text;
           Nota_Condicao_Pgto_3.Text        := ConexaoBD.SQL_FB_Notas_Entradasfb_nota_entrada_cond_pgto_3.Text;
           Nota_Condicao_Pgto_4.Text        := ConexaoBD.SQL_FB_Notas_Entradasfb_nota_entrada_cond_pgto_4.Text;
...
procedure THistoricosNotasFiscaisEntradas01.Exibe_Grid_Produtos();
...
begin
     ...
     //*** Valor Unitário ***
     SGD_Produtos.Cells[7,0]   := 'Valor (R$)';
     SGD_Produtos.ColWidths[7] := 80;

     //*** Valor Total ***
     SGD_Produtos.Cells[8,0]   := 'Vlr.Total (R$)';
     SGD_Produtos.ColWidths[8] := 75;

     //*** ICMS ***
     SGD_Produtos.Cells[9,0]   := 'ICMS%';
     SGD_Produtos.ColWidths[9] := 40;

     //*** IPI ***
     SGD_Produtos.Cells[10,0]   := 'IPI %';
     SGD_Produtos.ColWidths[10] := 30;

     //*** Valor Total ***
     SGD_Produtos.Cells[11,0]   := 'Vlr.IPI (R$)';
     SGD_Produtos.ColWidths[11] := 60;
     ...
     If ConexaoBD.SQL_FB_Notas_Entradas_Produtos.RecordCount > 0 Then
        ...
        While Not ConexaoBD.SQL_FB_Notas_Entradas_Produtos.Eof Do
              ...
              //*** Valor Unitário ***
              SGD_Produtos.Cells[7,Ind]   := ConexaoBD.SQL_FB_Notas_Entradas_Produtosfb_nota_entrada_produto_vlr_unit.Text;

              //*** Valor Total ***
              SGD_Produtos.Cells[8,Ind]   := ConexaoBD.SQL_FB_Notas_Entradas_Produtosfb_nota_entrada_produto_vlr_total.Text;

              //*** ICMS ***
              SGD_Produtos.Cells[9,Ind]   := ConexaoBD.SQL_FB_Notas_Entradas_Produtosfb_nota_entrada_produto_icms.Text;

              //*** IPI ***
              SGD_Produtos.Cells[10,Ind]  := ConexaoBD.SQL_FB_Notas_Entradas_Produtosfb_nota_entrada_produto_ipi.Text;

              //*** Valor IPI ***
              SGD_Produtos.Cells[11,Ind]  := ConexaoBD.SQL_FB_Notas_Entradas_Produtosfb_nota_entrada_produto_vlr_ipi.Text;

              HistoricosNotasFiscaisEntradas01.SGD_Produtos.RowCount := Ind + 2;
...
procedure THistoricosNotasFiscaisEntradas01.Exibe_Grid_Servicos();
...
procedure THistoricosNotasFiscaisEntradas01.Exibe_Grid_Vencimentos();
...
begin
     ...
     If ConexaoBD.SQL_FB_Notas_Entradas_Venctos.RecordCount > 0 Then
        ...
        While Not ConexaoBD.SQL_FB_Notas_Entradas_Venctos.Eof Do
              ...
              HistoricosNotasFiscaisEntradas01.SGD_Vencimentos.RowCount := Ind + 2;
...
procedure THistoricosNotasFiscaisEntradas01.Nota_NumeroKeyPress(Sender: TObject;
  var Key: Char);
begin
...
procedure THistoricosNotasFiscaisEntradas01.Nota_EmissaoKeyPress(Sender: TObject;
  var Key: Char);
begin
     If Key = #13 Then
        Begin
...
procedure THistoricosNotasFiscaisEntradas01.Nota_EntradaKeyPress(Sender: TObject;
  var Key: Char);
begin
     If Key = #13 Then
        Begin
...
procedure THistoricosNotasFiscaisEntradas01.Nota_RecebimentoKeyPress(Sender: TObject;
  var Key: Char);
begin
     If Key = #13 Then
        Begin
...
procedure THistoricosNotasFiscaisEntradas01.Nota_CFOPKeyPress(Sender: TObject;
  var Key: Char);
begin
     If Key = #13 Then
        Begin
...
procedure THistoricosNotasFiscaisEntradas01.Nota_NaturezaKeyPress(Sender: TObject;
  var Key: Char);
begin
     If Key = #13 Then
        Begin
...
procedure THistoricosNotasFiscaisEntradas01.Nota_Condicao_Pgto_1KeyPress(
...
procedure THistoricosNotasFiscaisEntradas01.Nota_Condicao_Pgto_2KeyPress(
  Sender: TObject; var Key: Char);
begin
     So_Numero(Sender,Key);
...
procedure THistoricosNotasFiscaisEntradas01.Nota_Condicao_Pgto_3KeyPress(
  Sender: TObject; var Key: Char);
begin
     So_Numero(Sender,Key);
...
procedure THistoricosNotasFiscaisEntradas01.Nota_Condicao_Pgto_4KeyPress(
  Sender: TObject; var Key: Char);
begin
     So_Numero(Sender,Key);
...
procedure THistoricosNotasFiscaisEntradas01.Nota_Descricao_Contas_PagarKeyPress(
  Sender: TObject; var Key: Char);
begin
     If Key = #13 Then
        Begin
...
procedure THistoricosNotasFiscaisEntradas01.Nota_Aliquota_ISSKeyPress(
  Sender: TObject; var Key: Char);
begin
     So_Valor(Sender,Key);
...
procedure THistoricosNotasFiscaisEntradas01.Nota_Valor_ISSKeyPress(Sender: TObject;
  var Key: Char);
begin
     So_Valor(Sender,Key);
...
procedure THistoricosNotasFiscaisEntradas01.Nota_Valor_ServicosKeyPress(
  Sender: TObject; var Key: Char);
begin
     So_Valor(Sender,Key);
...
procedure THistoricosNotasFiscaisEntradas01.Nota_Base_ICMSKeyPress(Sender: TObject;
  var Key: Char);
begin
     So_Valor(Sender,Key);
...
procedure THistoricosNotasFiscaisEntradas01.Nota_Valor_ICMSKeyPress(Sender: TObject;
  var Key: Char);
begin
     So_Valor(Sender,Key);
...
procedure THistoricosNotasFiscaisEntradas01.Nota_Base_ICMS_SubKeyPress(
  Sender: TObject; var Key: Char);
begin
     So_Valor(Sender,Key);
...
procedure THistoricosNotasFiscaisEntradas01.Nota_Valor_ICMS_SubKeyPress(
  Sender: TObject; var Key: Char);
begin
     So_Valor(Sender,Key);
...
procedure THistoricosNotasFiscaisEntradas01.Nota_Valor_ProdutoKeyPress(
  Sender: TObject; var Key: Char);
begin
     So_Valor(Sender,Key);
...
procedure THistoricosNotasFiscaisEntradas01.Nota_Valor_FreteKeyPress(Sender: TObject;
  var Key: Char);
begin
     So_Valor(Sender,Key);
...
procedure THistoricosNotasFiscaisEntradas01.Nota_Valor_SeguroKeyPress(
  Sender: TObject; var Key: Char);
begin
     So_Valor(Sender,Key);
...
procedure THistoricosNotasFiscaisEntradas01.Nota_Outras_DespesasKeyPress(
  Sender: TObject; var Key: Char);
begin
     So_Valor(Sender,Key);
...
procedure THistoricosNotasFiscaisEntradas01.Nota_Valor_IPIKeyPress(Sender: TObject;
  var Key: Char);
begin
     So_Valor(Sender,Key);
...
procedure THistoricosNotasFiscaisEntradas01.Nota_Valor_NotaKeyPress(Sender: TObject;
  var Key: Char);
begin
     So_Valor(Sender,Key);
...
procedure THistoricosNotasFiscaisEntradas01.Transportadora_CNPJKeyPress(
  Sender: TObject; var Key: Char);
begin
     If Key = #13 Then
        Begin
...
procedure THistoricosNotasFiscaisEntradas01.Transportadora_NomeKeyPress(
  Sender: TObject; var Key: Char);
begin
     If Key = #13 Then
        Begin
...
procedure THistoricosNotasFiscaisEntradas01.Nota_Pgto_FreteKeyPress(Sender: TObject;
  var Key: Char);
begin
     If Key = #13 Then
        Begin
...
procedure THistoricosNotasFiscaisEntradas01.Nota_QtdeKeyPress(Sender: TObject;
  var Key: Char);
begin
     So_Numero(Sender,Key);
...
procedure THistoricosNotasFiscaisEntradas01.Nota_EspecieKeyPress(Sender: TObject;
  var Key: Char);
begin
     If Key = #13 Then
        Begin
...
procedure THistoricosNotasFiscaisEntradas01.Nota_MarcaKeyPress(Sender: TObject;
  var Key: Char);
begin
     If Key = #13 Then
        Begin
...
procedure THistoricosNotasFiscaisEntradas01.Nota_Peso_BrutoKeyPress(Sender: TObject;
  var Key: Char);
begin
     So_Valor(Sender,Key);
...
procedure THistoricosNotasFiscaisEntradas01.Nota_Peso_LiquidoKeyPress(
  Sender: TObject; var Key: Char);
begin
     So_Valor(Sender,Key);
...
procedure THistoricosNotasFiscaisEntradas01.Nota_ObsKeyPress(Sender: TObject;
  var Key: Char);
begin
     If Key = #13 Then
        Begin
...
procedure THistoricosNotasFiscaisEntradas01.Nota_Condicao_Pgto_1Exit(
  Sender: TObject);
begin
...
procedure THistoricosNotasFiscaisEntradas01.Nota_Condicao_Pgto_2Exit(
  Sender: TObject);
begin
     If Trim(Nota_Condicao_Pgto_2.Text) = '' Then
        Begin
        Nota_Condicao_Pgto_2.Text := '0';
     End;
end;

procedure THistoricosNotasFiscaisEntradas01.Nota_Condicao_Pgto_3Exit(
  Sender: TObject);
begin
     If Trim(Nota_Condicao_Pgto_3.Text) = '' Then
        Begin
        Nota_Condicao_Pgto_3.Text := '0';
     End;
end;

procedure THistoricosNotasFiscaisEntradas01.Nota_Condicao_Pgto_4Exit(
  Sender: TObject);
begin
     If Trim(Nota_Condicao_Pgto_4.Text) = '' Then
        Begin
        Nota_Condicao_Pgto_4.Text := '0';
     End;
end;

procedure THistoricosNotasFiscaisEntradas01.Nota_Aliquota_ISSExit(Sender: TObject);
begin
...
procedure THistoricosNotasFiscaisEntradas01.Nota_Valor_ISSExit(Sender: TObject);
begin
...
procedure THistoricosNotasFiscaisEntradas01.Nota_Valor_ServicosExit(Sender: TObject);
begin
...
procedure THistoricosNotasFiscaisEntradas01.Nota_Base_ICMSExit(Sender: TObject);
begin
...
procedure THistoricosNotasFiscaisEntradas01.Nota_Valor_ICMSExit(Sender: TObject);
begin
...
procedure THistoricosNotasFiscaisEntradas01.Nota_Base_ICMS_SubExit(Sender: TObject);
begin
...
procedure THistoricosNotasFiscaisEntradas01.Nota_Valor_ICMS_SubExit(Sender: TObject);
begin
...
procedure THistoricosNotasFiscaisEntradas01.Nota_Valor_ProdutoExit(Sender: TObject);
begin
...
procedure THistoricosNotasFiscaisEntradas01.Nota_Valor_FreteExit(Sender: TObject);
begin
...
procedure THistoricosNotasFiscaisEntradas01.Nota_Valor_SeguroExit(Sender: TObject);
begin
...
procedure THistoricosNotasFiscaisEntradas01.Nota_Outras_DespesasExit(
  Sender: TObject);
begin
...
procedure THistoricosNotasFiscaisEntradas01.Nota_Valor_IPIExit(Sender: TObject);
begin
...
procedure THistoricosNotasFiscaisEntradas01.Nota_Valor_NotaExit(Sender: TObject);
begin
...
procedure THistoricosNotasFiscaisEntradas01.Nota_QtdeExit(Sender: TObject);
begin
...
procedure THistoricosNotasFiscaisEntradas01.Nota_Peso_BrutoExit(Sender: TObject);
begin
...
procedure THistoricosNotasFiscaisEntradas01.Nota_Peso_LiquidoExit(Sender: TObject);
begin
...
procedure THistoricosNotasFiscaisEntradas01.BT_ExcluirClick(Sender: TObject);
begin
...
procedure THistoricosNotasFiscaisEntradas01.FormClose(Sender: TObject;
...
begin
     ...
     Action := caFree;
     Release;
     HistoricosNotasFiscaisEntradas01 := Nil;
end;

procedure THistoricosNotasFiscaisEntradas01.BT_AdicionarClick(Sender: TObject);
begin
     If Trim(Fornecedor_Numero.Text) <> '' Then
        Begin
        Ampulheta();
...
procedure THistoricosNotasFiscaisEntradas01.BT_Adicionar_ServicosClick(
  Sender: TObject);
begin
     If Trim(Fornecedor_Numero.Text) <> '' Then
        Begin
...
procedure THistoricosNotasFiscaisEntradas01.BT_Adicionar_VenctosClick(
  Sender: TObject);
begin
     If Trim(Fornecedor_Numero.Text) <> '' Then
        Begin
...
procedure THistoricosNotasFiscaisEntradas01.SGD_ProdutosDblClick(Sender: TObject);
begin
     If Trim(Fornecedor_Numero.Text) <> '' Then
        Begin
        ...
        If (Trim(SGD_Produtos.Cells[6, SGD_Produtos.Row]) <> '') And (Trim(SGD_Produtos.Cells[6, SGD_Produtos.Row]) <> '0') Then
           ...
           NotasFiscaisEntradas03.Adiciona_Vlr_Unitario.Text   := SGD_Produtos.Cells[7, SGD_Produtos.Row];
           NotasFiscaisEntradas03.Adiciona_Vlr_Total.Text      := SGD_Produtos.Cells[8, SGD_Produtos.Row];
           NotasFiscaisEntradas03.Adiciona_ICMS.Text           := SGD_Produtos.Cells[9, SGD_Produtos.Row];
           NotasFiscaisEntradas03.Adiciona_IPI.Text            := SGD_Produtos.Cells[10,SGD_Produtos.Row];
           NotasFiscaisEntradas03.Adiciona_Vlr_IPI.Text        := SGD_Produtos.Cells[11,SGD_Produtos.Row];
...
procedure THistoricosNotasFiscaisEntradas01.SGD_ServicosDblClick(Sender: TObject);
begin
     If Trim(Fornecedor_Numero.Text) <> '' Then
        Begin
...
procedure THistoricosNotasFiscaisEntradas01.SGD_VencimentosDblClick(Sender: TObject);
begin
     If Trim(Fornecedor_Numero.Text) <> '' Then
        Begin
...
procedure THistoricosNotasFiscaisEntradas01.BT_ProcurarClick(Sender: TObject);
begin
...
procedure THistoricosNotasFiscaisEntradas01.BT_AlterarClick(Sender: TObject);
...
begin
     If Valida_Dados() Then
        ...
        Comando_SQL := Comando_SQL + 'fb_nota_entrada_cond_pgto_2, ';
        Comando_SQL := Comando_SQL + 'fb_nota_entrada_cond_pgto_3, ';
        Comando_SQL := Comando_SQL + 'fb_nota_entrada_cond_pgto_4, ';
        ...
        Comando_SQL := Comando_SQL + Trim(Nota_Condicao_Pgto_1.Text) + ',';
        Comando_SQL := Comando_SQL + Trim(Nota_Condicao_Pgto_2.Text) + ',';
        Comando_SQL := Comando_SQL + Trim(Nota_Condicao_Pgto_3.Text) + ',';
        Comando_SQL := Comando_SQL + Trim(Nota_Condicao_Pgto_4.Text) + ',';
...
procedure THistoricosNotasFiscaisEntradas01.Nota_CFOP_2KeyPress(Sender: TObject;
  var Key: Char);
begin
     If Key = #13 Then
        Begin
