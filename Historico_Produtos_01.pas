...
type
  THistoricoProdutos01 = class(TForm)
    GroupBox1: TGroupBox;
    GroupBox2: TGroupBox;
    Panel1: TPanel;
    BitBtn1: TBitBtn;
...
var
  HistoricoProdutos01: THistoricoProdutos01;

implementation

uses Conexao_BD, Rotinas_Gerais, Historico_Clientes_02,
  Historico_Produtos_02;

{$R *.dfm}

procedure THistoricoProdutos01.Carrega_Grid_Saidas();
...
procedure THistoricoProdutos01.Carrega_Grid_Entradas();
...
procedure THistoricoProdutos01.FormShow(Sender: TObject);
begin
    Ampulheta();
    Carrega_Grid_Saidas();
...
procedure THistoricoProdutos01.BitBtn1Click(Sender: TObject);
begin
    HistoricoProdutos01.Close;
end;

procedure THistoricoProdutos01.SGD_SaidasDblClick(Sender: TObject);
begin
     If Trim(SGD_Saidas.Cells[0,SGD_Saidas.Row]) <> '' Then
        ...
        HistoricoClientes02.Nro_Pedido.Text     := Trim(SGD_Saidas.Cells[1,SGD_Saidas.Row]);
        HistoricoClientes02.Tipo_Fatura.Text    := Trim(SGD_Saidas.Cells[0,SGD_Saidas.Row]);
...
procedure THistoricoProdutos01.SGD_EntradasDblClick(Sender: TObject);
begin
     If Trim(SGD_Entradas.Cells[0,SGD_Entradas.Row]) <> '' Then
        Begin

        Application.CreateForm(THistoricoProdutos02,HistoricoProdutos02);

        HistoricoProdutos02.Nro_Nota_Fiscal.Text     := Trim(SGD_Entradas.Cells[1,SGD_Entradas.Row]);

        HistoricoProdutos02.ShowModal;
        HistoricoProdutos02.Destroy;
     End;
end;
