object RelImpostosPisCofins03: TRelImpostosPisCofins03
  Left = 439
  Top = 180
  BorderIcons = [biSystemMenu, biMinimize]
  BorderStyle = bsSingle
  Caption = 'RelImpostosPisCofins03'
  ClientHeight = 322
  ClientWidth = 794
  Color = clBtnFace
  ...
  object QR_Imposto_Pis_Cofins: TQuickRep
    ...
    DataSet = ConexaoBD.SQL_MB_Rel_Impostos_Pis_Cofins
    Font.Charset = DEFAULT_CHARSET
    Font.Color = clWindowText
    Font.Height = -13
    Font.Name = 'Arial'
    ...
    object DetailBand1: TQRBand
      ...
      object QRDBText1: TQRDBText
        ...
        Color = clWhite
        DataSet = ConexaoBD.SQL_MB_Rel_Impostos_Pis_Cofins
        DataField = 'mb_nota_fiscal_numero'
        Transparent = False
        WordWrap = True
        FontSize = 10
      end
      object QRDBText2: TQRDBText
        ...
        Color = clWhite
        DataSet = ConexaoBD.SQL_MB_Rel_Impostos_Pis_Cofins
        DataField = 'mb_nota_fiscal_codigo'
        Transparent = False
        WordWrap = True
        FontSize = 10
      end
      ...
      object QRDBText4: TQRDBText
        ...
        Color = clWhite
        DataSet = ConexaoBD.SQL_MB_Rel_Impostos_Pis_Cofins
        DataField = 'mb_nota_fiscal_data_emissao'
        Transparent = False
        WordWrap = True
        FontSize = 10
      end
