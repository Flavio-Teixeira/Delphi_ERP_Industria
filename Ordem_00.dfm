object Ordem00: TOrdem00
  ...
  object GroupBox1: TGroupBox
    ...
    object DBGrid_Grupos: TDBGrid
      ...
      Height = 146
      Ctl3D = False
      DataSource = ConexaoBD.DS_Ordem_Rel
  ...
  object Panel3: TPanel
    ...
    object BT_Incluir: TBitBtn
      ...
      Width = 217
      Height = 25
      Caption = '&Criar uma Nova Ordem de Compra'
      TabOrder = 0
    ...
    object DBG_Ordem_Observacao: TDBMemo
      Left = 102
      Top = 14
      Width = 8
      Height = 19
      Ctl3D = False
      DataField = 'fb_ordem_observacao'
      DataSource = ConexaoBD.DS_Ordem_Rel
      ParentCtl3D = False
      TabOrder = 3
      Visible = False
