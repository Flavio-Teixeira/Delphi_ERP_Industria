...
type
  TNotasFiscaisSaidas01 = class(TForm)
    Panel3: TPanel;
    BT_Sair: TBitBtn;
    Panel1: TPanel;
    GroupBox1: TGroupBox;
  ...
  private
    ...
    procedure Grava_OS_Ibrasmak(Posicao_Inicial, Posicao_Final: Integer);
...
var
  NotasFiscaisSaidas01: TNotasFiscaisSaidas01;
...
uses Conexao_BD, Rotinas_Gerais, Adiciona_Lote_Produto, MSG_NF_Etapa_01,
  MSG_NF_Etapa_02, MSG_NF_Etapa_04, Ibrasmak_00,
...
function TNotasFiscaisSaidas01.ConversaoRecursiva(N: LongWord): string;
begin
    case N of
...
function TNotasFiscaisSaidas01.Extenso(parmNumero: Real): string;
begin
...
function TNotasFiscaisSaidas01.Letra_Maiuscula(Texto: String): string;
...
function TNotasFiscaisSaidas01.Prepara_Volume(Posicao_Inicial, Posicao_Final: Integer): string;
...
procedure TNotasFiscaisSaidas01.Carrega_Transportadoras();
begin
     Ampulheta();
...
procedure TNotasFiscaisSaidas01.Carrega_Pgto_Frete();
begin
...
procedure TNotasFiscaisSaidas01.Exibe_Grid_Produtos();
...
procedure TNotasFiscaisSaidas01.Imprime_Nota();
...
begin
     ...
     If (Imprimir_Tela.Checked = False) And (Trim(Tipo_Nota_Emissao.Text) = '') And (Registra_OS.Checked = False) Then
        Begin
...
procedure TNotasFiscaisSaidas01.Imprime_OS();
...
procedure TNotasFiscaisSaidas01.Imprime_Nota_Ibrasmak(Posicao_Inicial, Posicao_Final: Integer);
...
begin
     ...
     For Ind := Posicao_Inicial To Posicao_Final Do
         ...
         If Trim(SGD_Produtos.Cells[1,Ind]) <> '' Then
            ...
            If Trim(Cliente_Pgto_Frete.Text) = 'Cliente' Then
               Begin
               BC_ICMS_Normal := BC_ICMS_Normal + StrToFloat(Ponto_Virgula(SGD_Produtos.Cells[7,Ind])) + Vlr_Frete_Produto;
               End
            Else
               Begin
     ...
     Linha := Linha + 3;
     Imprimir.PoeStr(Linha,010, Trim(ETP_Numero_Nota.Text));
     ...
     Else
        Begin
        Grava_Nota_Ibrasmak(Posicao_Inicial, Posicao_Final);
        ...
        NotasFiscaisSaidas01.Close;
     End;

     Seta();
end;

procedure TNotasFiscaisSaidas01.Imprime_OS_Ibrasmak(Posicao_Inicial, Posicao_Final: Integer);
...
//******************************************************************************************
     ...
     Else
        Begin
        Grava_OS_Ibrasmak(Posicao_Inicial, Posicao_Final);
        NotasFiscaisSaidas01.Close;
     End;
...
procedure TNotasFiscaisSaidas01.Prepara_Condicao();
...
begin
     Parcela_Descricao.Text := StringReplace(Parcela_Descricao.Text,'D','',[rfReplaceAll]);
     Parcela_Descricao.Text := StringReplace(Parcela_Descricao.Text,'L','',[rfReplaceAll]);

     Parcela_Descricao.Text := StringReplace(Parcela_Descricao.Text,'d','',[rfReplaceAll]);
     Parcela_Descricao.Text := StringReplace(Parcela_Descricao.Text,'l','',[rfReplaceAll]);

     Parcela_Descricao.Text := Trim(Parcela_Descricao.Text);
...
procedure TNotasFiscaisSaidas01.Grava_Nota_Ibrasmak(Posicao_Inicial, Posicao_Final: Integer);
...
begin
     ...
     Comando_SQL := Comando_SQL + 'fb_nf_anterior_data = ' +#39+ Trim(Inverte_Data_Plus(ETP_Data_Emissao_Nota.Text,'amd','/')) +#39+ ', ';
     Comando_SQL := Comando_SQL + 'fb_nf_anterior_numero = ' + Trim(ETP_Numero_Nota.Text);
     ...
     Comando_SQL := Comando_SQL + 'fb_nota_fiscal_cfop_2, ';
     Comando_SQL := Comando_SQL + 'fb_nota_fiscal_revenda, ';
     Comando_SQL := Comando_SQL + 'fb_nota_fiscal_observacao_fatura, ';
     ...
     Comando_SQL := Comando_SQL + 'fb_nota_fiscal_email, ';
     Comando_SQL := Comando_SQL + 'fb_nota_fiscal_status_envio) ';
     ...
     Comando_SQL := Comando_SQL + 'fb_historico_cfop_2,';
     Comando_SQL := Comando_SQL + 'fb_historico_revenda)';
     Comando_SQL := Comando_SQL + ' Values(';
     Comando_SQL := Comando_SQL + #39 + Trim(Cliente_Codigo.Text) + #39 + ',';
     Comando_SQL := Comando_SQL + #39 + Trim(Cliente_Tipo_Faturamento.Text) + #39 + ',';
     Comando_SQL := Comando_SQL + Trim(ETP_Numero_Nota.Text) + ',';
...
procedure TNotasFiscaisSaidas01.Grava_OS_Ibrasmak(Posicao_Inicial, Posicao_Final: Integer);
...
begin
     ...
     Comando_SQL := 'Update fb_nf_anterior Set ';
     Comando_SQL := Comando_SQL + 'fb_nf_anterior_data_ped = ' +#39+ Trim(Inverte_Data_Plus(ETP_Data_Emissao_Nota.Text,'amd','/')) +#39+ ', ';
     Comando_SQL := Comando_SQL + 'fb_nf_anterior_numero_ped = ' + Trim(ETP_Numero_Nota.Text);
     ...
     Comando_SQL := Comando_SQL + 'fb_papeleta_cond_pgto_4, ';
     ...
     Comando_SQL := Comando_SQL + 'fb_papeleta_dup_nro_4, ';
     Comando_SQL := Comando_SQL + 'fb_papeleta_dup_forma_4, ';
     ...
     Comando_SQL := Comando_SQL + 'fb_papeleta_nro_pedido, ';
     Comando_SQL := Comando_SQL + 'fb_papeleta_cfop, ';
     Comando_SQL := Comando_SQL + 'fb_papeleta_icms, ';
     Comando_SQL := Comando_SQL + 'fb_papeleta_ordem_compra, ';
     Comando_SQL := Comando_SQL + 'fb_papeleta_observacao_fatura) ';
     Comando_SQL := Comando_SQL + 'Values(';
     ...
     Comando_SQL := 'select * from fb_papeletas_produtos where fb_papeleta_produto_numero = ' + Trim(ETP_Numero_Nota.Text);
     ...
     If ConexaoBD.SQL_FB_Papeletas_Produtos.RecordCount > 0 Then
        Begin
        Comando_SQL := 'delete from fb_papeletas_produtos where fb_papeleta_produto_numero = ' + Trim(ETP_Numero_Nota.Text);
...
procedure TNotasFiscaisSaidas01.BT_SairClick(Sender: TObject);
begin
     NotasFiscaisSaidas01.Close;
end;

procedure TNotasFiscaisSaidas01.FormShow(Sender: TObject);
begin
    If Imprimir_Tela.Checked = True Then
       Begin
       Imprimir.ArqDestino := 'C:\Ibrasmak\NF_Tela.TXT';
...
procedure TNotasFiscaisSaidas01.FormCreate(Sender: TObject);
begin
...
procedure TNotasFiscaisSaidas01.SGD_ProdutosDblClick(Sender: TObject);
begin
        Application.CreateForm(TAdicionaQtdeProduto,AdicionaQtdeProduto);

        AdicionaQtdeProduto.BT_Trocar.Enabled    := False;
        AdicionaQtdeProduto.BT_Adicionar.Enabled := True;
...
procedure TNotasFiscaisSaidas01.BT_ImprimirClick(Sender: TObject);
...
begin
     ...
     Else
        ...
        Else
           ...
           Application.CreateForm(TMSGNFEtapa01,MSGNFEtapa01);

           If Trim(Tipo_Nota_Emissao.Text) = 'NFe' Then
              Begin
              MSGNFEtapa01.Data_Emissao_Nota.Enabled := False;
           End;

           MSGNFEtapa01.ShowModal;
           MSGNFEtapa01.Destroy;
           ...
           If ETP_Resultado.Text = 'Etapa_02' Then
              ...
              Application.CreateForm(TMSGNFEtapa02,MSGNFEtapa02);
              MSGNFEtapa02.ShowModal;
              MSGNFEtapa02.Destroy;

              //*** Etapa 04 - Confirmar a Emissão da Nota ***

              If ETP_Resultado.Text = 'Etapa_04' Then
                 Begin
                 Application.CreateForm(TMSGNFEtapa04,MSGNFEtapa04);

                 If ((Trim(Tipo_Nota_Emissao.Text) = 'NFe') And (Imprimir_Tela.Checked = False)) Then
                    Begin
                    MSGNFEtapa04.Label1.Caption := 'Nota Fiscal pronta para Transmissão.';
                    MSGNFEtapa04.Label2.Caption := 'Deseja Transmitir?';
                    End
                 Else If ((Trim(Tipo_Nota_Emissao.Text) = 'NFe') And (Imprimir_Tela.Checked = True)) Then
                    Begin
                    MSGNFEtapa04.Label1.Caption := 'Nota Fiscal pronta para aparecer na Tela.';
                    MSGNFEtapa04.Label2.Caption := 'Deseja Visualizar?';
                 End;
                 
                 MSGNFEtapa04.ShowModal;
                 MSGNFEtapa04.Destroy;
...
procedure TNotasFiscaisSaidas01.SGD_ProdutosKeyPress(Sender: TObject;
  var Key: Char);
begin
     If Key = #13 Then
        Begin
...
procedure TNotasFiscaisSaidas01.Natureza_OperacaoChange(Sender: TObject);
begin
     Cliente_Natureza_Operacao.Text := Natureza_Operacao.Text;
end;

procedure TNotasFiscaisSaidas01.Cliente_DescontoKeyPress(Sender: TObject;
  var Key: Char);
begin
     So_Valor(Sender,Key);
...
procedure TNotasFiscaisSaidas01.Cliente_Tipo_TransporteKeyPress(
...
procedure TNotasFiscaisSaidas01.Cliente_Pgto_FreteKeyPress(Sender: TObject;
  var Key: Char);
begin
     If Key = #13 Then
        Begin
...
procedure TNotasFiscaisSaidas01.Natureza_OperacaoKeyPress(Sender: TObject;
  var Key: Char);
begin
     If Key = #13 Then
        Begin
...
procedure TNotasFiscaisSaidas01.Cliente_CFOPKeyPress(Sender: TObject;
  var Key: Char);
begin
     If Key = #13 Then
        Begin
...
procedure TNotasFiscaisSaidas01.Cliente_Natureza_OperacaoKeyPress(
  Sender: TObject; var Key: Char);
begin
     If Key = #13 Then
        Begin
...
procedure TNotasFiscaisSaidas01.Cliente_Aliquota_ICMSKeyPress(
  Sender: TObject; var Key: Char);
begin
     So_Valor(Sender,Key);
...
procedure TNotasFiscaisSaidas01.Cliente_Tipo_FaturamentoKeyPress(
  Sender: TObject; var Key: Char);
begin
     If Key = #13 Then
        Begin
...
procedure TNotasFiscaisSaidas01.Cliente_TransportadoraKeyPress(
  Sender: TObject; var Key: Char);
begin
     If Key = #13 Then
        Begin
...
procedure TNotasFiscaisSaidas01.Cliente_Emite_LoteKeyPress(Sender: TObject;
  var Key: Char);
begin
     If Key = #13 Then
        Begin
...
procedure TNotasFiscaisSaidas01.Qtde_VolumeKeyPress(Sender: TObject;
  var Key: Char);
begin
...
procedure TNotasFiscaisSaidas01.EspecieKeyPress(Sender: TObject;
  var Key: Char);
begin
     If Key = #13 Then
        Begin
...
procedure TNotasFiscaisSaidas01.MarcaKeyPress(Sender: TObject;
  var Key: Char);
begin
     If Key = #13 Then
        Begin
...
procedure TNotasFiscaisSaidas01.Peso_BrutoKeyPress(Sender: TObject;
  var Key: Char);
begin
     So_Valor(Sender,Key);
...
procedure TNotasFiscaisSaidas01.Peso_LiquidoKeyPress(Sender: TObject;
  var Key: Char);
begin
     So_Valor(Sender,Key);
...
procedure TNotasFiscaisSaidas01.Cliente_Base_ReduzidaKeyPress(
  Sender: TObject; var Key: Char);
begin
     So_Valor(Sender,Key);
...
procedure TNotasFiscaisSaidas01.Opcao_Natureza_OperacaoKeyPress(Sender: TObject;
  var Key: Char);
begin
     If Key = #13 Then
        Begin
...
procedure TNotasFiscaisSaidas01.Cliente_CFOP_2KeyPress(Sender: TObject;
  var Key: Char);
begin
     If Key = #13 Then
        Begin
...
procedure TNotasFiscaisSaidas01.Cliente_AlimentacaoKeyPress(
  Sender: TObject; var Key: Char);
begin
     If Key = #13 Then
        Begin
...
procedure TNotasFiscaisSaidas01.Cliente_SolicitadoKeyPress(Sender: TObject;
  var Key: Char);
begin
     If Key = #13 Then
        Begin
...
procedure TNotasFiscaisSaidas01.ComboBox4KeyPress(Sender: TObject;
  var Key: Char);
begin
     If Key = #13 Then
        Begin
...
procedure TNotasFiscaisSaidas01.ComboBox1KeyPress(Sender: TObject;
  var Key: Char);
begin
     If Key = #13 Then
        Begin
...
procedure TNotasFiscaisSaidas01.ComboBox2KeyPress(Sender: TObject;
  var Key: Char);
begin
     If Key = #13 Then
        Begin
...
procedure TNotasFiscaisSaidas01.Cliente_Ordem_CompraKeyPress(
  Sender: TObject; var Key: Char);
begin
     If Key = #13 Then
        Begin
...
procedure TNotasFiscaisSaidas01.Opcao_Natureza_OperacaoChange(Sender: TObject);
var
  Nro_Natureza : string;
...
procedure TNotasFiscaisSaidas01.Imprimir_TelaClick(Sender: TObject);
begin
    If Imprimir_Tela.Checked = True Then
       Begin
       Imprimir.ArqDestino := 'C:\Ibrasmak\NF_Tela.TXT';
...
procedure TNotasFiscaisSaidas01.Cliente_DescontoExit(Sender: TObject);
var
  Erro: Integer;
...
procedure TNotasFiscaisSaidas01.Altera_Faturado();
