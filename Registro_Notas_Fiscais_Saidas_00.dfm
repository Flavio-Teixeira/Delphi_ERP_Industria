object RegistroNotasFiscaisSaidas00: TRegistroNotasFiscaisSaidas00
  Left = 302
  Top = 180
  ...
  object Panel1: TPanel
    ...
    object Panel2: TPanel
      ...
      object GroupBox1: TGroupBox
        ...
        object DBG_Notas_Saidas_MB: TDBGrid
          Left = 8
          Top = 14
          Width = 718
          Height = 344
          Ctl3D = False
          DataSource = ConexaoBD.DS_MB_Nota_Fiscal
          Options = [dgTitles, dgIndicator, dgColumnResize, dgColLines, dgRowLines, dgTabs, dgRowSelect, dgConfirmDelete, dgCancelOnExit]
          ParentCtl3D = False
          ReadOnly = True
          TabOrder = 2
          ...
          TitleFont.Style = []
          Visible = False
          OnCellClick = DBG_Notas_Saidas_MBCellClick
          Columns = <
            item
              Expanded = False
              FieldName = 'mb_nota_fiscal_numero'
              Title.Alignment = taCenter
              Title.Caption = 'Nro. Nota'
              Title.Font.Charset = DEFAULT_CHARSET
              Title.Font.Color = clWindowText
            ...
            item
              Alignment = taCenter
              Expanded = False
              FieldName = 'mb_nota_fiscal_data_emissao'
              Title.Alignment = taCenter
              Title.Caption = 'Emiss'#227'o'
              Title.Font.Charset = DEFAULT_CHARSET
              Title.Font.Color = clWindowText
            ...
            item
              Expanded = False
              FieldName = 'mb_nota_fiscal_valor_total'
              Title.Alignment = taRightJustify
              Title.Caption = 'Vlr.Total'
              Title.Font.Charset = DEFAULT_CHARSET
              Title.Font.Color = clWindowText
  ...
  object Panel3: TPanel
    ...
    object DBG_FB_Cliente_Observacao_Nota: TDBMemo
      Left = 22
      Top = 6
      Width = 10
      Height = 19
    ...
    object DBG_MB_Cliente_Observacao: TDBMemo
      ...
      Height = 19
      Ctl3D = False
      DataField = 'mb_nota_fiscal_observacao_log'
      DataSource = ConexaoBD.DS_MB_Nota_Fiscal
      ParentCtl3D = False
      TabOrder = 4
      Visible = False
    end
    object DBG_MB_Cliente_Observacao_Nota: TDBMemo
      Left = 54
      Top = 6
      Width = 10
      Height = 19
      Ctl3D = False
      DataField = 'mb_nota_fiscal_observacao'
      DataSource = ConexaoBD.DS_MB_Nota_Fiscal
      ParentCtl3D = False
      TabOrder = 5
      Visible = False
  ...
  object Panel4: TPanel
    ...
    object Nome_Cliente: TEdit
      ...
      ParentCtl3D = False
      TabOrder = 5
      OnKeyPress = Nome_ClienteKeyPress
    end
  end
end
