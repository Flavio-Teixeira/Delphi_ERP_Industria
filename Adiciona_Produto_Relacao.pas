...
var
  AdicionaProdutoRelacao: TAdicionaProdutoRelacao;
...
uses Conexao_BD, Rotinas_Gerais, Pedidos_01, Pedidos_02,
  ...
  Requisicao_03, Requisicao_04, StrUtils, Registro_Notas_Fiscais_Saidas_02;
...
function TAdicionaProdutoRelacao.Verifica_Produto_Adicionado(): Boolean;
...
begin
     ...
     If (Trim(Programa_Anterior.Text) = 'Pedido-Inclusao') Then
        ...
        End
     //Else If (Trim(Programa_Anterior.Text) = 'Troca-Produto-Inclusao') Or (Trim(Programa_Anterior.Text) = 'Pedidos-Pendentes') Or (Trim(Programa_Anterior.Text) = 'Mapa-Produção') Then
     Else If (Trim(Programa_Anterior.Text) = 'Troca-Produto-Inclusao') Then
        Begin
        ...
        End
     Else If (Trim(Programa_Anterior.Text) = 'Pedidos-Pendentes') Or (Trim(Programa_Anterior.Text) = 'Mapa-Produção') Then
        Begin
        End
     ...
     Else If Trim(Programa_Anterior.Text) = 'Registro-Notas-Inclusão' Then
        ...
        For Ind := 1 To RegistroNotasFiscaisSaidas01.SGD_Produtos.RowCount Do
            ...
            If Trim(RegistroNotasFiscaisSaidas01.SGD_Produtos.Cells[1,Ind]) = Trim(DBGrid_FB_Produtos.Fields[1].Text) Then
               Begin
               Resultado := False;
            End;
        End;
     ...
     Else If Trim(Programa_Anterior.Text) = 'Registro-Notas-Inclusão-MB' Then
        ...
        For Ind := 1 To RegistroNotasFiscaisSaidas02.SGD_Produtos.RowCount Do
            ...
            If Trim(RegistroNotasFiscaisSaidas02.SGD_Produtos.Cells[1,Ind]) = Trim(DBGrid_FB_Produtos.Fields[1].Text) Then
               Begin
               Resultado := False;
            End;
        End;
...
procedure TAdicionaProdutoRelacao.Exibe_Produtos();
...
begin
    ...
    Else If Trim(Programa_Anterior.Text) = 'Registro-Notas-Inclusão' Then Begin
        Comando_SQL := 'Select * from fb_produtos Where fb_produto_pedido_padrao = '+#39+'N'+#39+' Order By fb_produto_codigo';
        End
    Else If Trim(Programa_Anterior.Text) = 'Registro-Notas-Inclusão-MB' Then Begin
        Comando_SQL := 'Select * from fb_produtos Where fb_produto_pedido_padrao = '+#39+'N'+#39+' Order By fb_produto_codigo';
        End
    Else Begin
...
procedure TAdicionaProdutoRelacao.FormCreate(Sender: TObject);
begin
...
procedure TAdicionaProdutoRelacao.FormShow(Sender: TObject);
begin
    Ampulheta();
    ...
    Or (Trim(Programa_Anterior.Text) = 'Troca-Produto-Inclusao') Or (Trim(Programa_Anterior.Text) = 'Registro-Notas-Inclusão') Or (Trim(Programa_Anterior.Text) = 'Registro-Notas-Inclusão-MB') Then
        Begin
        Label4.Visible       := True;
        ...
        Or (Trim(Programa_Anterior.Text) = 'Troca-Produto-Inclusao') Or (Trim(Programa_Anterior.Text) = 'Registro-Notas-Inclusão') Or (Trim(Programa_Anterior.Text) = 'Registro-Notas-Inclusão-MB') Then
           Begin
           Produto_Tipo.ItemIndex := 5;
           End
        Else If ((Trim(Programa_Anterior.Text) = 'Cotação-Inclusao') Or (Trim(Programa_Anterior.Text) = 'Cotação-Alteração') Or (Trim(Programa_Anterior.Text) = 'Requisição-Inclusao') Or (Trim(Programa_Anterior.Text) = 'Requisição-Alteração') Or (Trim(Programa_Anterior.Text) = 'Ordem-Inclusao') Or (Trim(Programa_Anterior.Text) = 'Ordem-Alteração')) Then
           Begin
           Produto_Tipo.ItemIndex   := Obtem_Nro_Tipo_Produto('5'); // Compras
           Opcoes_Procura.ItemIndex := 2;
        End;
...
procedure TAdicionaProdutoRelacao.BT_SairClick(Sender: TObject);
begin
     AdicionaProdutoRelacao.Close;
end;

procedure TAdicionaProdutoRelacao.BT_ProcurarClick(Sender: TObject);
begin
    Ampulheta();
    ...
    Or (Trim(Programa_Anterior.Text) = 'Ordem-Inclusao') Or (Trim(Programa_Anterior.Text) = 'Ordem-Alteração') Then Begin
        ...
        If Trim(Dados_Procura.Text) <> '' Then Begin
            ...
            If Trim(Produto_Tipo.Text) = '0 --- Todos ---' Then
               Begin

                If Opcoes_Procura.Text = 'Código' Then Begin
                  ConexaoBD.SQL_FB_Produtos.SQL.Add('Select * from fb_produtos Where fb_produto_codigo Like ' +#39+'%'+ Trim(Dados_Procura.Text) +'%'+#39+' And fb_produto_fornecedor = ' + Trim(Nro_Fornecedor.Text) + ' Order By fb_produto_codigo');
                  End
                Else If Opcoes_Procura.Text = 'Referência' Then Begin
                  ConexaoBD.SQL_FB_Produtos.SQL.Add('Select * from fb_produtos Where fb_produto_referencia Like ' +#39+'%'+ Trim(Dados_Procura.Text) +'%'+#39+' And fb_produto_fornecedor = ' + Trim(Nro_Fornecedor.Text) + ' Order By fb_produto_referencia');
                  End
                Else If Opcoes_Procura.Text = 'Descrição' Then Begin
                  ConexaoBD.SQL_FB_Produtos.SQL.Add('Select * from fb_produtos Where fb_produto_descricao Like ' +#39+'%'+ Trim(Dados_Procura.Text) +'%'+#39+ ' And fb_produto_fornecedor = ' + Trim(Nro_Fornecedor.Text) + ' Order By fb_produto_descricao');
                  End
                Else If Opcoes_Procura.Text = 'Desenho' Then Begin
                  ConexaoBD.SQL_FB_Produtos.SQL.Add('Select * from fb_produtos Where fb_produto_desenho Like ' +#39+'%'+ Trim(Dados_Procura.Text) +'%'+#39+ ' And fb_produto_fornecedor = ' + Trim(Nro_Fornecedor.Text) + ' Order By fb_produto_descricao');
                  End
                Else If Opcoes_Procura.Text = 'OS' Then Begin
                  ConexaoBD.SQL_FB_Produtos.SQL.Add('Select * from fb_produtos Where fb_produto_os Like ' +#39+'%'+ Trim(Dados_Procura.Text) +'%'+#39+ ' And fb_produto_fornecedor = ' + Trim(Nro_Fornecedor.Text) + ' Order By fb_produto_descricao');
                  End
                Else If Opcoes_Procura.Text = 'Equipamento' Then Begin
                  ConexaoBD.SQL_FB_Produtos.SQL.Add('Select * from fb_produtos Where fb_produto_equipamento Like ' +#39+'%'+ Trim(Dados_Procura.Text) +'%'+#39+ ' And fb_produto_fornecedor = ' + Trim(Nro_Fornecedor.Text) + ' Order By fb_produto_descricao');
                  End
                Else If Opcoes_Procura.Text = 'Material' Then Begin
                  ConexaoBD.SQL_FB_Produtos.SQL.Add('Select * from fb_produtos Where fb_produto_material Like ' +#39+'%'+ Trim(Dados_Procura.Text) +'%'+#39+ ' And fb_produto_fornecedor = ' + Trim(Nro_Fornecedor.Text) + ' Order By fb_produto_descricao');
                End;
        ...
        Else Begin
            ...
            If Trim(Produto_Tipo.Text) = '0 --- Todos ---' Then
               Begin
                ...
                If Opcoes_Procura.Text = 'Código' Then Begin
                  ConexaoBD.SQL_FB_Produtos.SQL.Add('Select * from fb_produtos Where fb_produto_fornecedor = ' + Trim(Nro_Fornecedor.Text) + ' Order By fb_produto_codigo');
                  End
                Else If Opcoes_Procura.Text = 'Referência' Then Begin
                  ConexaoBD.SQL_FB_Produtos.SQL.Add('Select * from fb_produtos Where fb_produto_fornecedor = ' + Trim(Nro_Fornecedor.Text) + ' Order By fb_produto_referencia');
                  End
                Else If Opcoes_Procura.Text = 'Descrição' Then Begin
                  ConexaoBD.SQL_FB_Produtos.SQL.Add('Select * from fb_produtos Where fb_produto_fornecedor = ' + Trim(Nro_Fornecedor.Text) + ' Order By fb_produto_descricao');
                  End
                Else If Opcoes_Procura.Text = 'Desenho' Then Begin
                  ConexaoBD.SQL_FB_Produtos.SQL.Add('Select * from fb_produtos Where fb_produto_fornecedor = ' + Trim(Nro_Fornecedor.Text) + ' Order By fb_produto_desenho');
                  End
                Else If Opcoes_Procura.Text = 'OS' Then Begin
                  ConexaoBD.SQL_FB_Produtos.SQL.Add('Select * from fb_produtos Where fb_produto_fornecedor = ' + Trim(Nro_Fornecedor.Text) + ' Order By fb_produto_os');
                  End
                Else If Opcoes_Procura.Text = 'Equipamento' Then Begin
                  ConexaoBD.SQL_FB_Produtos.SQL.Add('Select * from fb_produtos Where fb_produto_fornecedor = ' + Trim(Nro_Fornecedor.Text) + ' Order By fb_produto_equipamento');
                  End
                Else If Opcoes_Procura.Text = 'Material' Then Begin
                  ConexaoBD.SQL_FB_Produtos.SQL.Add('Select * from fb_produtos Where fb_produto_fornecedor = ' + Trim(Nro_Fornecedor.Text) + ' Order By fb_produto_material');
                End;
    ...
    Or (Trim(Programa_Anterior.Text) = 'Troca-Produto-Inclusao') Or (Trim(Programa_Anterior.Text) = 'Registro-Notas-Inclusão') Or (Trim(Programa_Anterior.Text) = 'Registro-Notas-Inclusão-MB') Then Begin
            ...
            If Trim(Produto_Tipo.Text) = '0 --- Todos ---' Then
               Begin
                ...
                If Opcoes_Procura.Text = 'Código' Then Begin
                  ...
                  End
                Else If Opcoes_Procura.Text = 'Referência' Then Begin
                  ConexaoBD.SQL_FB_Produtos.SQL.Add('Select * from fb_produtos Where fb_produto_referencia Like ' +#39+'%'+ Trim(Dados_Procura.Text) +'%'+#39+' Order By fb_produto_referencia');
                  End
                Else If Opcoes_Procura.Text = 'Descrição' Then Begin
                  ...
                  End
                Else If Opcoes_Procura.Text = 'Desenho' Then Begin
                  ConexaoBD.SQL_FB_Produtos.SQL.Add('Select * from fb_produtos Where fb_produto_desenho Like ' +#39+'%'+ Trim(Dados_Procura.Text) +'%'+#39+ ' Order By fb_produto_descricao');
                  End
                Else If Opcoes_Procura.Text = 'OS' Then Begin
                  ConexaoBD.SQL_FB_Produtos.SQL.Add('Select * from fb_produtos Where fb_produto_os Like ' +#39+'%'+ Trim(Dados_Procura.Text) +'%'+#39+ ' Order By fb_produto_descricao');
                  End
                Else If Opcoes_Procura.Text = 'Equipamento' Then Begin
                  ConexaoBD.SQL_FB_Produtos.SQL.Add('Select * from fb_produtos Where fb_produto_equipamento Like ' +#39+'%'+ Trim(Dados_Procura.Text) +'%'+#39+ ' Order By fb_produto_descricao');
                  End
                Else If Opcoes_Procura.Text = 'Material' Then Begin
                  ConexaoBD.SQL_FB_Produtos.SQL.Add('Select * from fb_produtos Where fb_produto_material Like ' +#39+'%'+ Trim(Dados_Procura.Text) +'%'+#39+ ' Order By fb_produto_descricao');
                End;
    ...
    Else If (Trim(Programa_Anterior.Text) = 'Pedidos-Pendentes') Then
        ...
        Else Begin
                ...
                If Opcoes_Procura.Text = 'Código' Then Begin
                  ...
                  End
                Else If Opcoes_Procura.Text = 'Referência' Then Begin
                  ConexaoBD.SQL_FB_Produtos.SQL.Add('Select * from fb_produtos Order By fb_produto_referencia');
                  End
                Else If Opcoes_Procura.Text = 'Descrição' Then Begin
                ...
                Else If Opcoes_Procura.Text = 'Desenho' Then Begin
                  ...
                  End
                Else If Opcoes_Procura.Text = 'OS' Then Begin
                  ConexaoBD.SQL_FB_Produtos.SQL.Add('Select * from fb_produtos Order By fb_produto_os');
                  End
                Else If Opcoes_Procura.Text = 'Equipamento' Then Begin
                  ConexaoBD.SQL_FB_Produtos.SQL.Add('Select * from fb_produtos Order By fb_produto_equipamento');
                  End
                Else If Opcoes_Procura.Text = 'Material' Then Begin
                  ConexaoBD.SQL_FB_Produtos.SQL.Add('Select * from fb_produtos Order By fb_produto_material');
                End;
...
procedure TAdicionaProdutoRelacao.DBGrid_FB_ProdutosCellClick(
  Column: TColumn);
        ...
        If Verifica_Produto_Adicionado() Then Begin
            ...
            Else Begin
              ...
              Else If Trim(Programa_Anterior.Text) = 'Registro-Notas-Inclusão-MB' Then Begin
                ...
                AdicionaQtdeProduto02.Programa_Anterior.Text       := Programa_Anterior.Text;
                AdicionaQtdeProduto02.Adiciona_ACol.Text           := IntToStr(RegistroNotasFiscaisSaidas02.SGD_Produtos.Col);
                AdicionaQtdeProduto02.Adiciona_ARow.Text           := IntToStr(RegistroNotasFiscaisSaidas02.SGD_Produtos.RowCount - 1);
                AdicionaQtdeProduto02.Adiciona_Codigo_Produto.Text := DBGrid_FB_Produtos.Fields[1].Text;
                AdicionaQtdeProduto02.Adiciona_Referencia.Text     := DBGrid_FB_Produtos.Fields[0].Text;
                AdicionaQtdeProduto02.Adiciona_Descricao.Text      := DBGrid_FB_Produtos.Fields[2].Text;
                AdicionaQtdeProduto02.Adiciona_Quantidade.Text     := '0';
...
procedure TAdicionaProdutoRelacao.Dados_ProcuraKeyPress(Sender: TObject;
  var Key: Char);
begin
     If Key = #13 Then
        Begin
...
procedure TAdicionaProdutoRelacao.Opcoes_ProcuraKeyPress(Sender: TObject;
  var Key: Char);
begin
     If Key = #13 Then
        Begin
...
procedure TAdicionaProdutoRelacao.Carrega_Tipo_Produto();
begin
     ...
     Produto_Tipo.Items.Add('0 --- Todos ---');
