...
type
  THistoricosPedidos01 = class(TForm)
    Panel3: TPanel;
...
var
  HistoricosPedidos01: THistoricosPedidos01;
...
uses Conexao_BD, Rotinas_Gerais, Clientes_02, Clientes_00,
  ...
  Pedidos_04, Pedidos_03, DB, Produtos_00, Pedidos_02;
...
function THistoricosPedidos01.Valida_Dados(): Boolean;
...
procedure THistoricosPedidos01.Exibe_Grid_Produtos();
...
begin
     ...
     If ConexaoBD.SQL_NF_FB_Pedidos_Produtos.RecordCount > 0 Then
        ...
        While Not ConexaoBD.SQL_NF_FB_Pedidos_Produtos.Eof Do
              ...
              SGD_Produtos.Cells[1,Ind] := ConexaoBD.SQL_NF_FB_Pedidos_Produtospedido_produto_codigo.Text;
              SGD_Produtos.Cells[2,Ind] := ConexaoBD.SQL_NF_FB_Pedidos_Produtospedido_produto_referencia.Text;
              SGD_Produtos.Cells[3,Ind] := ConexaoBD.SQL_NF_FB_Pedidos_Produtospedido_produto_descricao.Text;
              ...
              SGD_Produtos.Cells[6,Ind] := '0';

              SGD_Produtos.Cells[7,Ind] := ConexaoBD.SQL_NF_FB_Pedidos_Produtospedido_produto_valor_ipi.Text;
              SGD_Produtos.Cells[8,Ind] := DBG_NF_FB_Pedido_Produto_Descricao_Detalhada.Text;
              SGD_Produtos.Cells[9,Ind] := ConexaoBD.SQL_NF_FB_Pedidos_Produtospedido_produto_unidade.Text;
     ...
     //*** Descrição Detalhada ***
     SGD_Produtos.Cells[8,0]   := 'Descrição Detalhada';
...
procedure THistoricosPedidos01.Carrega_Transportadoras();
begin
     Ampulheta();
...
procedure THistoricosPedidos01.Carrega_Pgto_Frete();
begin
...
procedure THistoricosPedidos01.Totaliza_Pedido();
...
procedure THistoricosPedidos01.Volta_Valores_Estoque(Usuario_HD, Empresa, Produto, Quantidade: String);
...
procedure THistoricosPedidos01.Volta_Valores_Estoque_Sair(Usuario_HD, Empresa, Produto: String);
...
procedure THistoricosPedidos01.BT_SairClick(Sender: TObject);
begin
     ...
     HistoricosPedidos01.Close;
end;

procedure THistoricosPedidos01.FormCreate(Sender: TObject);
begin
...
procedure THistoricosPedidos01.FormShow(Sender: TObject);
var
    Ind: Integer;
...
procedure THistoricosPedidos01.BT_AlterarClick(Sender: TObject);
...
procedure THistoricosPedidos01.BT_ProcurarClick(Sender: TObject);
begin
     Ampulheta();
...
procedure THistoricosPedidos01.BT_AdicionarClick(Sender: TObject);
begin
     Ampulheta();
...
procedure THistoricosPedidos01.SGD_ProdutosDblClick(Sender: TObject);
...
begin
     ...
     If Acessa_Qtde = True Then
        ...
        ConexaoBD.SQL_FB_Produtos.Close;
        ConexaoBD.SQL_FB_Produtos.SQL.Clear;
        ConexaoBD.SQL_FB_Produtos.SQL.Add('Select * from fb_produtos Where fb_produto_codigo = '+#39+ Trim(SGD_Produtos.Cells[1,SGD_Produtos.Row]) +#39);
        ConexaoBD.SQL_FB_Produtos.Open;
...
procedure THistoricosPedidos01.Cliente_DescontoKeyPress(Sender: TObject;
  var Key: Char);
begin
     If Key = #13 Then
        Begin
...
procedure THistoricosPedidos01.Cliente_DescontoExit(Sender: TObject);
begin
     Totaliza_Pedido();
end;

procedure THistoricosPedidos01.SGD_ProdutosKeyPress(Sender: TObject; var Key: Char);
...
procedure THistoricosPedidos01.Cliente_Condicao_Pgto_1KeyPress(Sender: TObject;
  var Key: Char);
begin
...
procedure THistoricosPedidos01.Cliente_Condicao_Pgto_2KeyPress(Sender: TObject;
  var Key: Char);
begin
     So_Numero(Sender,Key);
...
procedure THistoricosPedidos01.Cliente_Condicao_Pgto_3KeyPress(Sender: TObject;
  var Key: Char);
begin
     So_Numero(Sender,Key);
...
procedure THistoricosPedidos01.Cliente_Tipo_FaturamentoKeyPress(Sender: TObject;
  var Key: Char);
begin
     If Key = #13 Then
        Begin
...
procedure THistoricosPedidos01.Cliente_Emite_LoteKeyPress(Sender: TObject;
  var Key: Char);
begin
     If Key = #13 Then
        Begin
...
procedure THistoricosPedidos01.Cliente_Tipo_TransporteKeyPress(Sender: TObject;
  var Key: Char);
begin
     If Key = #13 Then
        Begin
...
procedure THistoricosPedidos01.Cliente_Pgto_FreteKeyPress(Sender: TObject;
  var Key: Char);
begin
     If Key = #13 Then
        Begin
...
procedure THistoricosPedidos01.Cliente_TransportadoraKeyPress(Sender: TObject;
  var Key: Char);
begin
     If Key = #13 Then
        Begin
...
procedure THistoricosPedidos01.BT_Alterar_PedidosClick(Sender: TObject);
...
procedure THistoricosPedidos01.BT_ExcluirClick(Sender: TObject);
...
procedure THistoricosPedidos01.Observacao_NotaKeyPress(Sender: TObject;
  var Key: Char);
begin
     If Key = #13 Then
        Begin
...
procedure THistoricosPedidos01.Valor_FreteExit(Sender: TObject);
begin
     Totaliza_Pedido();
end;

procedure THistoricosPedidos01.Valor_FreteKeyPress(Sender: TObject; var Key: Char);
begin
     So_Valor(Sender,Key);
...
procedure THistoricosPedidos01.Cliente_Tipo_TabelaKeyPress(Sender: TObject;
  var Key: Char);
begin
     If Key = #13 Then
        Begin
...
procedure THistoricosPedidos01.Forma_PagamentoKeyPress(Sender: TObject;
  var Key: Char);
begin
     If Key = #13 Then
        Begin
...
procedure THistoricosPedidos01.Natureza_OperacaoKeyPress(Sender: TObject;
  var Key: Char);
begin
     If Key = #13 Then
        Begin
...
procedure THistoricosPedidos01.BT_ImprimirClick(Sender: TObject);
...
begin
        ...
        Else If OPC_Faturamento.Checked Then
           ...
           Pedidos03.lblEndereco.Caption  := Trim(ConexaoBD.SQL_FB_Clientesfb_cliente_endereco_entrega.Text) + ' ' + Trim(ConexaoBD.SQL_FB_Clientesfb_cliente_complemento_entrega.Text);
           Pedidos03.lblCidade.Caption    := ConexaoBD.SQL_FB_Clientesfb_cliente_cidade_entrega.Text;
           Pedidos03.lblBairro.Caption    := ConexaoBD.SQL_FB_Clientesfb_cliente_bairro_entrega.Text;
           Pedidos03.lblEstado.Caption    := ConexaoBD.SQL_FB_Clientesfb_cliente_estado_entrega.Text;
           Pedidos03.lblCEP.Caption       := ConexaoBD.SQL_FB_Clientesfb_cliente_cep_entrega.Text;
           ...
           Pedidos03.lblObservacoes.Lines.Add(Observacao_Nota.Text);
...
procedure THistoricosPedidos01.BT_FaturamentoClick(Sender: TObject);

var
   Ind: Integer;
   Com_Qtde_Produto: Boolean;
   Qtde_Fat, Comando_SQL: string;
...
begin
     ...
     For Ind := 1 To SGD_Produtos.RowCount Do Begin
        ...
        Comando_SQL := Comando_SQL +    '(f_p.faturado_produto_codigo = ' +#39+ Trim(SGD_Produtos.Cells[1,Ind]) +#39+ ') And ';
        Comando_SQL := Comando_SQL +    '(fat.faturado_pedido_numero IN (' + Trim(Nro_Pedido.Text) + ') ) And ';
        ...
        Pedidos04.SGD_Produtos.Cells[2,Ind] := SGD_Produtos.Cells[1,Ind];
        Pedidos04.SGD_Produtos.Cells[3,Ind] := SGD_Produtos.Cells[2,Ind];
        Pedidos04.SGD_Produtos.Cells[4,Ind] := SGD_Produtos.Cells[3,Ind];
        Pedidos04.SGD_Produtos.Cells[5,Ind] := SGD_Produtos.Cells[4,Ind];
        Pedidos04.SGD_Produtos.Cells[6,Ind] := SGD_Produtos.Cells[5,Ind];
        Pedidos04.SGD_Produtos.Cells[7,Ind] := SGD_Produtos.Cells[6,Ind];
         ...
         Else
            Begin
            Pedidos04.SGD_Produtos.Cells[8,Ind] := SGD_Produtos.Cells[7,Ind];
         End;

         Pedidos04.SGD_Produtos.Cells[9,Ind] := SGD_Produtos.Cells[8,Ind];
         Pedidos04.SGD_Produtos.Cells[10,Ind] := SGD_Produtos.Cells[9,Ind];
     End;
     ...
     If Trim(Envia_Faturamento.Text) = 'Ok' Then
        ...
        For Ind := 1 To SGD_Produtos.RowCount Do
            Begin
            If StrToFloat(Virgula_Ponto(Pedidos02.SGD_Produtos.Cells[0,Ind])) > 0 Then
               Begin
...
procedure THistoricosPedidos01.Data_EntregaKeyPress(Sender: TObject; var Key: Char);
begin
     If Key = #13 Then
        Begin
        Key := #0;
...
procedure THistoricosPedidos01.Data_EntregaExit(Sender: TObject);
begin
     Totaliza_Pedido();
end;

procedure THistoricosPedidos01.FormClose(Sender: TObject; var Action: TCloseAction);
begin
     //*** Recarrega o Grid da Tela Anterior ***
     ...
     Action := caFree;
     Release;
     HistoricosPedidos01 := Nil;
end;

procedure THistoricosPedidos01.Cliente_AlimentacaoKeyPress(Sender: TObject;
  var Key: Char);
begin
     If Key = #13 Then
        Begin
...
procedure THistoricosPedidos01.Cliente_PesoKeyPress(Sender: TObject; var Key: Char);
begin
     So_Valor(Sender,Key);
...
procedure THistoricosPedidos01.Cliente_VolumeKeyPress(Sender: TObject;
  var Key: Char);
begin
     So_Valor(Sender,Key);
...
procedure THistoricosPedidos01.Financiamento_BNDSKeyPress(Sender: TObject;
  var Key: Char);
begin
     If Key = #13 Then
        Begin
...
procedure THistoricosPedidos01.Financiamento_ProgerKeyPress(Sender: TObject;
  var Key: Char);
begin
     If Key = #13 Then
        Begin
...
procedure THistoricosPedidos01.Financiamento_LeasingKeyPress(Sender: TObject;
  var Key: Char);
begin
     If Key = #13 Then
        Begin
...
procedure THistoricosPedidos01.Financiamento_IbrasmakKeyPress(Sender: TObject;
  var Key: Char);
begin
     If Key = #13 Then
        Begin
...
procedure THistoricosPedidos01.Pagamento_VistaKeyPress(Sender: TObject;
  var Key: Char);
begin
     If Key = #13 Then
        Begin
...
procedure THistoricosPedidos01.Pagamento_ParceladoKeyPress(Sender: TObject;
  var Key: Char);
begin
     If Key = #13 Then
        Begin
...
procedure THistoricosPedidos01.Pagamento_CombinarKeyPress(Sender: TObject;
  var Key: Char);
begin
     If Key = #13 Then
        Begin
...
procedure THistoricosPedidos01.Parcela_NroKeyPress(Sender: TObject; var Key: Char);
begin
     So_Numero(Sender,Key);
...
procedure THistoricosPedidos01.Parcela_VenctoKeyPress(Sender: TObject;
  var Key: Char);
begin
     So_Numero(Sender,Key);
...
procedure THistoricosPedidos01.Parcela_Dias_VenctoKeyPress(Sender: TObject;
  var Key: Char);
begin
     So_Numero(Sender,Key);
...
procedure THistoricosPedidos01.Parcela_PedidoKeyPress(Sender: TObject;
  var Key: Char);
begin
     If Key = #13 Then
        Begin
...
procedure THistoricosPedidos01.Parcela_FaturamentoKeyPress(Sender: TObject;
  var Key: Char);
begin
     If Key = #13 Then
        Begin
...
procedure THistoricosPedidos01.Parcela_Mes_SubsequenteKeyPress(Sender: TObject;
  var Key: Char);
begin
     If Key = #13 Then
        Begin
...
procedure THistoricosPedidos01.Parcela_Porcentagem_AtoKeyPress(Sender: TObject;
  var Key: Char);
begin
     So_Valor(Sender,Key);
...
procedure THistoricosPedidos01.Parcela_Vlr_AtoKeyPress(Sender: TObject;
  var Key: Char);
begin
     So_Valor(Sender,Key);
...
procedure THistoricosPedidos01.Parcela_Prazo_InicioKeyPress(Sender: TObject;
  var Key: Char);
begin
     So_Numero(Sender,Key);
...
procedure THistoricosPedidos01.Parcela_Porcentagem_AtoExit(Sender: TObject);
...
procedure THistoricosPedidos01.Pagamento_VistaClick(Sender: TObject);
begin
...
procedure THistoricosPedidos01.Pagamento_ParceladoClick(Sender: TObject);
begin
...
procedure THistoricosPedidos01.Pagamento_CombinarClick(Sender: TObject);
begin
     Forma_Parcelamento.Enabled := True;
     Valor_Ato.Enabled          := True;
...
procedure THistoricosPedidos01.Parcela_DescricaoExit(Sender: TObject);
...
procedure THistoricosPedidos01.BT_ProdutosClick(Sender: TObject);
begin
