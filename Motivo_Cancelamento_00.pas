...
type
  TMotivoCancelamento00 = class(TForm)
    Panel2: TPanel;
    Panel1: TPanel;
    GroupBox1: TGroupBox;
    Label2: TLabel;
...
var
  MotivoCancelamento00: TMotivoCancelamento00;
...
procedure TMotivoCancelamento00.BT_OKClick(Sender: TObject);
...
begin
    if (Trim(Edit_Operador.Text) = '') then begin
      ...
      MotivoCancelamento00.Close;
    end;
end;

procedure TMotivoCancelamento00.FormClose(Sender: TObject;
