...
type
  TRelVencidosNota00 = class(TForm)
    Panel1: TPanel;
    Label1: TLabel;
...
var
  RelVencidosNota00: TRelVencidosNota00;

implementation

uses Conexao_BD, Rotinas_Gerais, Rel_Vencidos_Nota_01, Ibrasmak_00;

{$R *.dfm}

procedure TRelVencidosNota00.BT_ImprimirClick(Sender: TObject);
var
...
begin
  if Trim(Data_Vencimento.Text) = '/  /' Then
    ...
    Application.CreateForm(TRelVencidosNota01,RelVencidosNota01);
    ...
    Comando_SQL := Comando_SQL + '(fb_nota_fiscal_tipo_fatura ='+#39+'Nota Fiscal'+#39+') ';
    ...
    RelVencidosNota01.QR_Emissao.Caption := 'Vencimento: ' + Data_Vencimento.Text;
// Preenche Campos de Expressão
    RelVencidosNota01.QRE_Banco1.Expression         := 'if((fb_nota_fiscal_dup_nro_1 <> '+#39+#39+') and (fb_nota_fiscal_dup_dt_vcto_1 <> '+#39+#39+'),fb_nota_fiscal_dup_cod_bco_1,'+#39+#39+')';
    RelVencidosNota01.QRE_Banco2.Expression         := 'if((fb_nota_fiscal_dup_nro_2 <> '+#39+#39+') and (fb_nota_fiscal_dup_dt_vcto_2 <> '+#39+#39+'),fb_nota_fiscal_dup_cod_bco_2,'+#39+#39+')';
    RelVencidosNota01.QRE_Banco3.Expression         := 'if((fb_nota_fiscal_dup_nro_3 <> '+#39+#39+') and (fb_nota_fiscal_dup_dt_vcto_3 <> '+#39+#39+'),fb_nota_fiscal_dup_cod_bco_3,'+#39+#39+')';
    RelVencidosNota01.QRE_Codigo1.Expression        := 'if((fb_nota_fiscal_dup_nro_1 <> '+#39+#39+') and (fb_nota_fiscal_dup_dt_vcto_1 <> '+#39+#39+'),fb_nota_fiscal_codigo,'+#39+#39+')';
    RelVencidosNota01.QRE_Codigo2.Expression        := 'if((fb_nota_fiscal_dup_nro_2 <> '+#39+#39+') and (fb_nota_fiscal_dup_dt_vcto_2 <> '+#39+#39+'),fb_nota_fiscal_codigo,'+#39+#39+')';
    RelVencidosNota01.QRE_Codigo3.Expression        := 'if((fb_nota_fiscal_dup_nro_3 <> '+#39+#39+') and (fb_nota_fiscal_dup_dt_vcto_3 <> '+#39+#39+'),fb_nota_fiscal_codigo,'+#39+#39+')';
    RelVencidosNota01.QRE_Nome1.Expression          := 'if((fb_nota_fiscal_dup_nro_1 <> '+#39+#39+') and (fb_nota_fiscal_dup_dt_vcto_1 <> '+#39+#39+'),fb_nota_fiscal_nome,'+#39+#39+')';
    RelVencidosNota01.QRE_Nome2.Expression          := 'if((fb_nota_fiscal_dup_nro_2 <> '+#39+#39+') and (fb_nota_fiscal_dup_dt_vcto_2 <> '+#39+#39+'),fb_nota_fiscal_nome,'+#39+#39+')';
    RelVencidosNota01.QRE_Nome3.Expression          := 'if((fb_nota_fiscal_dup_nro_3 <> '+#39+#39+') and (fb_nota_fiscal_dup_dt_vcto_3 <> '+#39+#39+'),fb_nota_fiscal_nome,'+#39+#39+')';
    RelVencidosNota01.QRE_Duplicata1.Expression     := 'if((fb_nota_fiscal_dup_nro_1 <> '+#39+#39+') and (fb_nota_fiscal_dup_dt_vcto_1 <> '+#39+#39+'),fb_nota_fiscal_dup_nro_1,'+#39+#39+')';
    RelVencidosNota01.QRE_Duplicata2.Expression     := 'if((fb_nota_fiscal_dup_nro_2 <> '+#39+#39+') and (fb_nota_fiscal_dup_dt_vcto_2 <> '+#39+#39+'),fb_nota_fiscal_dup_nro_2,'+#39+#39+')';
    RelVencidosNota01.QRE_Duplicata3.Expression     := 'if((fb_nota_fiscal_dup_nro_3 <> '+#39+#39+') and (fb_nota_fiscal_dup_dt_vcto_3 <> '+#39+#39+'),fb_nota_fiscal_dup_nro_3,'+#39+#39+')';
    RelVencidosNota01.QRE_Emissao1.Expression       := 'if((fb_nota_fiscal_dup_nro_1 <> '+#39+#39+') and (fb_nota_fiscal_dup_dt_vcto_1 <> '+#39+#39+'),fb_nota_fiscal_data_emissao,'+#39+#39+')';
    RelVencidosNota01.QRE_Emissao2.Expression       := 'if((fb_nota_fiscal_dup_nro_2 <> '+#39+#39+') and (fb_nota_fiscal_dup_dt_vcto_2 <> '+#39+#39+'),fb_nota_fiscal_data_emissao,'+#39+#39+')';
    RelVencidosNota01.QRE_Emissao3.Expression       := 'if((fb_nota_fiscal_dup_nro_3 <> '+#39+#39+') and (fb_nota_fiscal_dup_dt_vcto_3 <> '+#39+#39+'),fb_nota_fiscal_data_emissao,'+#39+#39+')';
    RelVencidosNota01.QRE_Vencimento1.Expression    := 'if((fb_nota_fiscal_dup_nro_1 <> '+#39+#39+') and (fb_nota_fiscal_dup_dt_vcto_1 <> '+#39+#39+'),fb_nota_fiscal_dup_dt_vcto_1,'+#39+#39+')';
    RelVencidosNota01.QRE_Vencimento2.Expression    := 'if((fb_nota_fiscal_dup_nro_2 <> '+#39+#39+') and (fb_nota_fiscal_dup_dt_vcto_2 <> '+#39+#39+'),fb_nota_fiscal_dup_dt_vcto_2,'+#39+#39+')';
    RelVencidosNota01.QRE_Vencimento3.Expression    := 'if((fb_nota_fiscal_dup_nro_3 <> '+#39+#39+') and (fb_nota_fiscal_dup_dt_vcto_3 <> '+#39+#39+'),fb_nota_fiscal_dup_dt_vcto_3,'+#39+#39+')';
    RelVencidosNota01.QRE_Vlr_Duplicata1.Expression := 'if((fb_nota_fiscal_dup_nro_1 <> '+#39+#39+') and (fb_nota_fiscal_dup_dt_vcto_1 <> '+#39+#39+'),formatnumeric('+#39+'0.00'+#39+',fb_nota_fiscal_dup_vlr_1),'+#39+#39+')';
    RelVencidosNota01.QRE_Vlr_Duplicata2.Expression := 'if((fb_nota_fiscal_dup_nro_2 <> '+#39+#39+') and (fb_nota_fiscal_dup_dt_vcto_2 <> '+#39+#39+'),formatnumeric('+#39+'0.00'+#39+',fb_nota_fiscal_dup_vlr_2),'+#39+#39+')';
    RelVencidosNota01.QRE_Vlr_Duplicata3.Expression := 'if((fb_nota_fiscal_dup_nro_3 <> '+#39+#39+') and (fb_nota_fiscal_dup_dt_vcto_3 <> '+#39+#39+'),formatnumeric('+#39+'0.00'+#39+',fb_nota_fiscal_dup_vlr_3),'+#39+#39+')';
    RelVencidosNota01.QRE_Atraso1.Expression        := 'if((fb_nota_fiscal_dup_nro_1 <> '+#39+#39+') and (fb_nota_fiscal_dup_dt_vcto_1 <> '+#39+#39+'),fb_nota_fiscal_dup_atraso_1,'+#39+#39+')';
    RelVencidosNota01.QRE_Atraso2.Expression        := 'if((fb_nota_fiscal_dup_nro_2 <> '+#39+#39+') and (fb_nota_fiscal_dup_dt_vcto_2 <> '+#39+#39+'),fb_nota_fiscal_dup_atraso_2,'+#39+#39+')';
    RelVencidosNota01.QRE_Atraso3.Expression        := 'if((fb_nota_fiscal_dup_nro_3 <> '+#39+#39+') and (fb_nota_fiscal_dup_dt_vcto_3 <> '+#39+#39+'),fb_nota_fiscal_dup_atraso_3,'+#39+#39+')';

    RelVencidosNota01.QRE_Total.Expression          := 'SUM((if((fb_nota_fiscal_dup_nro_1 <> '+#39+#39+') and (fb_nota_fiscal_dup_dt_vcto_1 <>'+#39+#39+'),fb_nota_fiscal_dup_vlr_1,0))+(if((fb_nota_fiscal_dup_nro_2 <> '+#39+#39+') and (fb_nota_fiscal_dup_dt_vcto_2 <>'+#39+#39+'),fb_nota_fiscal_dup_vlr_2,0))+(if((fb_nota_fiscal_dup_nro_3 <> '+#39+#39+') and (fb_nota_fiscal_dup_dt_vcto_3 <>'+#39+#39+'),fb_nota_fiscal_dup_vlr_3,0)))';

    RelVencidosNota01.QR_Vencidos.Preview;
    RelVencidosNota01.Destroy;
  end;
end;

procedure TRelVencidosNota00.Data_VencimentoKeyPress(Sender: TObject;
  var Key: Char);
begin
     If Key = #13 Then
        Begin
...
procedure TRelVencidosNota00.BT_SairClick(Sender: TObject);
begin
  RelVencidosNota00.Close;
end;

procedure TRelVencidosNota00.FormCreate(Sender: TObject);
begin
//*** Trabalha com o Ano de 4 Dígitos ***
     ShortDateFormat := 'dd/mm/yyyy';
end;

procedure TRelVencidosNota00.FormShow(Sender: TObject);
begin
