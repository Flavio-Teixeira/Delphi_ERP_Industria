...
begin
    If DBGrid_Grupos.Fields[0].Text <> '' Then Begin
      ...
      If (Ordem02 = Nil) Then Begin
        ...
        If Trim(ConexaoBD.SQL_Ordem_Rel.FieldByName('fb_ordem_utilizacao').Text) = 'Industrialização' Then
           Begin
        ...
        Else If Trim(ConexaoBD.SQL_Ordem_Rel.FieldByName('fb_ordem_status').Text) = 'Emitida - Aguardando Entrega' Then
           ...
           End
        Else If Trim(ConexaoBD.SQL_Ordem_Rel.FieldByName('fb_ordem_status').Text) = 'Conferência de Itens' Then
           Begin
...
begin
    ...
    Ordem03.QR_Periodo.Caption := 'Período de ' + Trim(Data_Inicial.Text) + ' a ' + Trim(Data_Final.Text);
