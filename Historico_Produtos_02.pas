...
type
  THistoricoProdutos02 = class(TForm)
    Panel3: TPanel;
    BT_Sair: TBitBtn;
    Panel1: TPanel;
    GroupBox1: TGroupBox;
...
var
  HistoricoProdutos02: THistoricoProdutos02;
...
procedure THistoricoProdutos02.FormShow(Sender: TObject);
var Ind: integer;
begin
    Ampulheta();
...
procedure THistoricoProdutos02.BT_SairClick(Sender: TObject);
begin
    HistoricoProdutos02.Close;
end;
