...
function Obtem_Nro_Empresa(Empresa: String): Integer;
function Obtem_Nro_Tipo(Tipo: String): Integer;
...
function Obtem_Nro_Banco(Banco: String): Integer;
function Obtem_Nro_Representante(Representante: String): Integer;
...
function Obtem_Nro_Familia_Produto(Familia: String): Integer;
function Obtem_Nro_Tipo_Produto(Tipo: String): Integer;
...
function Obtem_Nro_Transportadora(Transportadora: String): Integer;
function Obtem_Nro_Fornecedor(Fornecedor: String): Integer;
...
function Obtem_Nro_Natureza_Operacao(Natureza_Operacao, CFOP: String): Integer;
function Obtem_Nro_Natureza_Operacao_N(Nro: String): Integer;

function Obtem_Nro_Banco_EMP(Empresa, Banco: String): Integer;
function Obtem_Nro_Representante_EMP(Empresa, Representante: String): Integer;
function Obtem_Nro_Familia_Produto_EMP(Empresa, Familia: String): Integer;
function Obtem_Nro_Tipo_Produto_EMP(Empresa, Tipo: String): Integer;
function Obtem_Nro_Transportadora_EMP(Empresa, Transportadora: String): Integer;
function Obtem_Nro_Tipo_Tabela_EMP(Empresa, Tipo_Tabela: String): Integer;
function Obtem_Nro_Pgto_Frete_EMP(Empresa, Pgto_Frete: String): Integer;
...
procedure FB_Registra_Movto_Estoque(Cod_Estoque, Nro_Ctrl_Estoque, Nro_Nota_Etoque, Tabela_Estoque, Prod_Estoque, Lote_Estoque, Qtde_Estoque: String);

{
*** Observações ***
Quando Teclar Enter e Pular para o Próximo
Campo Usar a Rotina Abaixo no KyePress:
...
//Colocar na Procedure Create do Formulário
...
var
   Ind, Resultado: Integer;
   Relacao_Empresa: Array[0..3] of String;

begin
     //Carrega o Array

     Relacao_Empresa[0]  := 'Ibrasmak';
     Relacao_Empresa[1]  := 'Monibras';
     Relacao_Empresa[2]  := 'Autônomo';
     Relacao_Empresa[3]  := 'Terceirizado';

     // Obtem o Número da Empresa no Array

     Resultado := 0;

     For Ind := 0 To 3 Do
         Begin
         If (Relacao_Empresa[Ind] = Trim(Empresa)) Then
            Begin
            Resultado := Ind;
         End;
     End;

     Obtem_Nro_Empresa := Resultado;
end;
...
var
   Ind, Resultado: Integer;
   Relacao_Tipo: Array[0..1] of String;

begin
     //Carrega o Array

     Relacao_Tipo[0]  := 'Fotolito';
     Relacao_Tipo[1]  := 'Digital';

     // Obtem o Número do Tipo no Array

     Resultado := 0;

     For Ind := 0 To 1 Do
         Begin
         If (Relacao_Tipo[Ind] = Trim(Tipo)) Then
            Begin
            Resultado := Ind;
         End;
     End;

     Obtem_Nro_Tipo := Resultado;
end;
...
var
   Ind, Ind_Total, Resultado: Integer;
   Relacao_Banco: Array of String;
   Encontrou: Boolean;

begin
     // Obtem os Tipos de Bancos e Carrega o Array
     ...
     If conexaoBD.SQL_Bancos.RecordCount > 0 Then
        ...
        Ind := 0;
        SetLength(Relacao_Banco, conexaoBD.SQL_Bancos.RecordCount);

        While Not conexaoBD.SQL_Bancos.Eof Do
              begin
              Relacao_Banco[Ind] := IntToStr(conexaoBD.SQL_Bancosfb_banco_codigo.AsInteger);
     ...
     // Obtem o Número do Tipo do Cliente no Array
     ...
     If Encontrou = True Then
        ...
        For Ind := 0 To Ind_Total Do
            Begin
            If (Relacao_Banco[Ind] = Trim(Banco)) Then
               Begin
               Resultado := Ind;
            End;
        End;
...
var
   Ind, Ind_Total, Resultado: Integer;
   Relacao_Representante: Array of String;
   Encontrou: Boolean;

begin
     // Obtem os Tipos de Representantes e Carrega o Array
     ...
     If conexaoBD.SQL_Representantes.RecordCount > 0 Then
        ...
        Ind := 0;
        SetLength(Relacao_Representante, conexaoBD.SQL_Representantes.RecordCount);

        While Not conexaoBD.SQL_Representantes.Eof Do
              begin
              Relacao_Representante[Ind] := IntToStr(conexaoBD.SQL_Representantesfb_representante_codigo.AsInteger);
     ...
     // Obtem o Número do Representante no Array
     ...
     If Encontrou = True Then
        ...
        For Ind := 0 To Ind_Total Do
            Begin
            If (Relacao_Representante[Ind] = Trim(Representante)) Then
               Begin
               Resultado := Ind;
            End;
        End;
...
var
   Ind, Ind_Total, Resultado: Integer;
   Relacao_Familia: Array of String;
   Encontrou: Boolean;

begin
     // Obtem os Tipos de Familias e Carrega o Array
     ...
     If conexaoBD.SQL_Familia_Produto.RecordCount > 0 Then
        ...
        Ind := 0;
        SetLength(Relacao_Familia, conexaoBD.SQL_Familia_Produto.RecordCount);

        While Not conexaoBD.SQL_Familia_Produto.Eof Do
              begin
              Relacao_Familia[Ind] := IntToStr(conexaoBD.SQL_Familia_Produtofb_familia_produto_codigo.AsInteger);
     ...
     // Obtem o Número da Familia no Array
     ...
     If Encontrou = True Then
        ...
        For Ind := 0 To Ind_Total Do
            Begin
            If (Relacao_Familia[Ind] = Trim(Familia)) Then
               Begin
               Resultado := Ind;
            End;
        End;
...
var
   Ind, Ind_Total, Resultado: Integer;
   Relacao_Tipo: Array of String;
   Encontrou: Boolean;

begin
     // Obtem os Tipos de Produto e Carrega o Array
     ...
     If conexaoBD.SQL_Tipo_Produto.RecordCount > 0 Then
        ...
        Ind := 0;
        SetLength(Relacao_Tipo, conexaoBD.SQL_Tipo_Produto.RecordCount);

        While Not conexaoBD.SQL_Tipo_Produto.Eof Do
              begin
              Relacao_Tipo[Ind] := IntToStr(conexaoBD.SQL_Tipo_Produtofb_tipo_produto_codigo.AsInteger);
...
var
   Ind, Ind_Total, Resultado: Integer;
   Relacao_Transportadora: Array of String;
   Encontrou: Boolean;

begin
     // Obtem as Transportadoras e Carrega o Array
     ...
     If conexaoBD.SQL_Transportadoras.RecordCount > 0 Then
        ...
        Ind := 0;
        SetLength(Relacao_Transportadora, conexaoBD.SQL_Transportadoras.RecordCount);

        While Not conexaoBD.SQL_Transportadoras.Eof Do
              begin
              Relacao_Transportadora[Ind] := IntToStr(conexaoBD.SQL_Transportadorasfb_transportadora_numero.AsInteger);
     ...
     // Obtem o Número da Transportadora no Array
     ...
     If Encontrou = True Then
        ...
        For Ind := 0 To Ind_Total Do
            Begin
            If (Relacao_Transportadora[Ind] = Trim(Transportadora)) Then
               Begin
               Resultado := Ind;
            End;
        End;
...
var
   Ind, Ind_Total, Resultado: Integer;
   Relacao_Fornecedor: Array of String;
   Encontrou: Boolean;
...
begin
     ...
     If conexaoBD.SQL_Fornecedores.RecordCount > 0 Then
        ...
        Ind := 0;
        SetLength(Relacao_Fornecedor, conexaoBD.SQL_Fornecedores.RecordCount);

        While Not conexaoBD.SQL_Fornecedores.Eof Do
              begin
              Relacao_Fornecedor[Ind] := IntToStr(conexaoBD.SQL_Fornecedoresfb_fornecedor_numero.AsInteger);
     ...
     // Obtem o Número do Fornecedor no Array
     ...
     If Encontrou = True Then
        ...
        For Ind := 0 To Ind_Total Do
            Begin
            If (Relacao_Fornecedor[Ind] = Trim(Fornecedor)) Then
               Begin
               Resultado := Ind;
            End;
        End;
...
var
   {Ind, Resultado: Integer;
   Relacao_Natureza_Operacao: Array[0..13] of String;}

   Ind, Ind_Total, Resultado: Integer;
   Relacao_Natureza, Relacao_CFOP: Array of String;
   Encontrou, Encontrou_Natureza: Boolean;

begin
     {//Carrega o Array

     Relacao_Natureza_Operacao[0]  := 'Vendas';
     Relacao_Natureza_Operacao[1]  := 'Remessa';
     Relacao_Natureza_Operacao[2]  := 'Outras Saídas';
     Relacao_Natureza_Operacao[3]  := 'Consignação';
     Relacao_Natureza_Operacao[4]  := 'Devolução';
     Relacao_Natureza_Operacao[5]  := 'Remessa Indus.';
     Relacao_Natureza_Operacao[6]  := 'Retorno Indus.';
     Relacao_Natureza_Operacao[7]  := 'Exportação';
     Relacao_Natureza_Operacao[8]  := 'Importação';
     Relacao_Natureza_Operacao[9]  := 'Simples Remessa';
     Relacao_Natureza_Operacao[10] := 'Retorno Sim.Rem';
     Relacao_Natureza_Operacao[11] := 'Rem. Exp.Feira';
     Relacao_Natureza_Operacao[12] := 'Ret. Exp.Feira';
     Relacao_Natureza_Operacao[13] := 'Entrada';
     ...
     For Ind := 0 To 13 Do
         Begin
         If (Relacao_Natureza_Operacao[Ind] = Trim(Natureza_Operacao)) Then
            Begin
            Resultado := Ind;
         End;
     End;
     ...
     If conexaoBD.SQL_Natureza_Operacao.RecordCount > 0 Then
        ...
        Ind := 0;
        SetLength(Relacao_Natureza, conexaoBD.SQL_Natureza_Operacao.RecordCount);
        SetLength(Relacao_CFOP, conexaoBD.SQL_Natureza_Operacao.RecordCount);

        While Not conexaoBD.SQL_Natureza_Operacao.Eof Do
              begin
              Relacao_Natureza[Ind] := Trim(conexaoBD.SQL_Natureza_Operacaofb_natureza_operacao_descricao_longa.Text);
              Relacao_CFOP[Ind]     := Trim(conexaoBD.SQL_Natureza_Operacaofb_natureza_operacao_cfop.Text);
     ...
     If Encontrou = True Then
        ...
        For Ind := 0 To Ind_Total Do
            ...
            If (Trim(CFOP) <> '') And (Trim(CFOP) <> '0') Then
               Begin
               If (Relacao_Natureza[Ind] = Trim(Natureza_Operacao)) And (Relacao_CFOP[Ind] = Trim(CFOP)) Then
                  Begin
                  Resultado := Ind;
                  Encontrou_Natureza := True;
               End;
               End
            Else
               Begin
               If (Relacao_Natureza[Ind] = Trim(Natureza_Operacao)) Then
                  Begin
                  Resultado := Ind;
                  Encontrou_Natureza := True;
               End;
     ...
     If Encontrou_Natureza = False Then
        Begin
        If Encontrou = True Then
           Begin
           For Ind := 0 To Ind_Total Do
               ...
               If (Relacao_CFOP[Ind] = Trim(CFOP)) Then
                  Begin
                  Resultado := Ind;
                  Encontrou_Natureza := True;
               End;
...
var
   Ind, Ind_Total, Resultado: Integer;
   Relacao_Natureza: Array of String;
   Encontrou: Boolean;
...
begin
     ...
     If conexaoBD.SQL_Natureza_Operacao.RecordCount > 0 Then
        ...
        While Not conexaoBD.SQL_Natureza_Operacao.Eof Do
              begin
              Relacao_Natureza[Ind] := Trim(conexaoBD.SQL_Natureza_Operacaofb_natureza_operacao_nro.Text);
              conexaoBD.SQL_Natureza_Operacao.Next;
              Ind := Ind + 1;
        End;
     ...
     If Encontrou = True Then
        ...
        For Ind := 0 To Ind_Total Do
            ...
            If (Relacao_Natureza[Ind] = Trim(Nro)) Then
               Begin
               Resultado := Ind;
               Break;
            End;
...
begin
     ...
     If conexaoBD.SQL_FB_Bancos.RecordCount > 0 Then
        ...
        Ind := 0;
        SetLength(Relacao_Banco, conexaoBD.SQL_FB_Bancos.RecordCount);

        While Not conexaoBD.SQL_FB_Bancos.Eof Do
              begin
              Relacao_Banco[Ind] := IntToStr(conexaoBD.SQL_FB_Bancosfb_banco_codigo.AsInteger);
...
begin
     ...
     If conexaoBD.SQL_FB_Representantes.RecordCount > 0 Then
        ...
        Ind := 0;
        SetLength(Relacao_Representante, conexaoBD.SQL_FB_Representantes.RecordCount);

        While Not conexaoBD.SQL_FB_Representantes.Eof Do
              begin
              Relacao_Representante[Ind] := IntToStr(conexaoBD.SQL_FB_Representantesfb_representante_codigo.AsInteger);
...
begin
     ...
     ConexaoBD.SQL_FB_Familia_Produto.Close;
     ConexaoBD.SQL_FB_Familia_Produto.SQL.Clear;
     ConexaoBD.SQL_FB_Familia_Produto.SQL.Add('Select * from fb_familias_produtos Order By fb_familia_produto_descricao');
     ConexaoBD.SQL_FB_Familia_Produto.Open;

     Encontrou := False;
     If conexaoBD.SQL_FB_Familia_Produto.RecordCount > 0 Then
        begin
        Encontrou := True;
        conexaoBD.SQL_FB_Familia_Produto.First;

        Ind := 0;
        SetLength(Relacao_Familia, conexaoBD.SQL_FB_Familia_Produto.RecordCount);

        While Not conexaoBD.SQL_FB_Familia_Produto.Eof Do
              begin
              Relacao_Familia[Ind] := IntToStr(conexaoBD.SQL_FB_Familia_Produtofb_familia_produto_codigo.AsInteger);
              conexaoBD.SQL_FB_Familia_Produto.Next;
              Ind := ind + 1;
        End;
...
begin
     ...
     ConexaoBD.SQL_FB_Tipo_Produto.Close;
     ConexaoBD.SQL_FB_Tipo_Produto.SQL.Clear;
     ConexaoBD.SQL_FB_Tipo_Produto.SQL.Add('Select * from fb_tipos_produtos Order By fb_tipo_produto_descricao');
     ConexaoBD.SQL_FB_Tipo_Produto.Open;

     Encontrou := False;
     If conexaoBD.SQL_FB_Tipo_Produto.RecordCount > 0 Then
        begin
        Encontrou := True;
        conexaoBD.SQL_FB_Tipo_Produto.First;

        Ind := 0;
        SetLength(Relacao_Tipo, conexaoBD.SQL_FB_Tipo_Produto.RecordCount);

        While Not conexaoBD.SQL_FB_Tipo_Produto.Eof Do
              begin
              Relacao_Tipo[Ind] := IntToStr(conexaoBD.SQL_FB_Tipo_Produtofb_tipo_produto_codigo.AsInteger);
              conexaoBD.SQL_FB_Tipo_Produto.Next;
              Ind := ind + 1;
        End;
...
begin
     ...
     If conexaoBD.SQL_FB_Transportadoras.RecordCount > 0 Then
        ...
        Ind := 0;
        SetLength(Relacao_Transportadora, conexaoBD.SQL_FB_Transportadoras.RecordCount);

        While Not conexaoBD.SQL_FB_Transportadoras.Eof Do
              begin
              Relacao_Transportadora[Ind] := IntToStr(conexaoBD.SQL_FB_Transportadorasfb_transportadora_numero.AsInteger);
...
var
   Comando_SQL, Desc_Estoque, Vlr_Unit_Estoque, Vlr_Tot_Estoque, Atual_Estoque, Posicao_Produto: String;
   Qtde_Estoque_Nro, Vlr_Unit_Estoque_Nro, Vlr_Tot_Estoque_Nro, Atual_Estoque_Nro, Posicao_Produto_Nro: Real;
   Erro: Integer;

begin
     If StrToInt(Cod_Estoque) <= 50 Then
        Begin

        Qtde_Estoque := Trim(Virgula_Ponto(Qtde_Estoque));
        Val(Qtde_Estoque,Qtde_Estoque_Nro,Erro);

        If Qtde_Estoque_Nro > 0 Then
           Begin

           ConexaoBD.SQL_FB_Produtos.Close;
           ConexaoBD.SQL_FB_Produtos.SQL.Clear;
           ConexaoBD.SQL_FB_Produtos.SQL.Add('Select * from fb_produtos Where fb_produto_codigo = ' +#39+ Trim(Prod_Estoque) +#39+ ' Order By fb_produto_codigo, fb_produto_descricao');
           ConexaoBD.SQL_FB_Produtos.Open;

           If ConexaoBD.SQL_FB_Produtos.RecordCount > 0 Then
              Begin
              Desc_Estoque := ConexaoBD.SQL_FB_Produtosfb_produto_descricao.Text;
              Vlr_Unit_Estoque := ConexaoBD.SQL_FB_Produtosfb_produto_preco.Text;

              //*** Obtem os Valores do Produto ***

              Qtde_Estoque := Trim(Virgula_Ponto(Qtde_Estoque));
              Val(Qtde_Estoque,Qtde_Estoque_Nro,Erro);

              Vlr_Unit_Estoque := Trim(Virgula_Ponto(Vlr_Unit_Estoque));
              Val(Vlr_Unit_Estoque,Vlr_Unit_Estoque_Nro,Erro);

              Vlr_Tot_Estoque_Nro := Vlr_Unit_Estoque_Nro * Qtde_Estoque_Nro;
              Str(Vlr_Tot_Estoque_Nro:13:2,Vlr_Tot_Estoque);
              Vlr_Tot_Estoque := Ponto_Virgula(Trim(Vlr_Tot_Estoque));

              //*** Obtem o Estoque Atual ***

              Atual_Estoque := ConexaoBD.SQL_FB_Produtosfb_produto_estoque_atual.Text;
              Atual_Estoque := Trim(Virgula_Ponto(Atual_Estoque));
              Val(Atual_Estoque,Atual_Estoque_Nro,Erro);

              Posicao_Produto_Nro := Atual_Estoque_Nro + Qtde_Estoque_Nro;
              Str(Posicao_Produto_Nro:13:2,Posicao_Produto);
              Posicao_Produto := Ponto_Virgula(Trim(Posicao_Produto));

              //*** Ajusta a Quantidade Na Tabela de Produtos ***

              Comando_SQL := 'Update fb_produtos Set fb_produto_estoque_atual = ' + Virgula_Ponto(Posicao_Produto);
              Comando_SQL := Comando_SQL + ' Where fb_produto_codigo = ' + #39 + Trim(Prod_Estoque) + #39;

              ConexaoBD.SQL_Comunitario.SQL.Clear;
              ConexaoBD.SQL_Comunitario.SQL.Add(Comando_SQL);
              ConexaoBD.SQL_Comunitario.ExecSQL;

              //*** Insere o Estoque Atual ***

              Comando_SQL := 'Insert into fb_movto_estoque(';
              Comando_SQL := Comando_SQL + 'fb_movto_estoque_cod_registro,';
              Comando_SQL := Comando_SQL + 'fb_movto_estoque_pedido,';
              Comando_SQL := Comando_SQL + 'fb_movto_estoque_codigo,';
              Comando_SQL := Comando_SQL + 'fb_movto_estoque_nota,';
              Comando_SQL := Comando_SQL + 'fb_movto_estoque_qtde,';
              Comando_SQL := Comando_SQL + 'fb_movto_estoque_descricao,';
              Comando_SQL := Comando_SQL + 'fb_movto_estoque_vlr_unitario,';
              Comando_SQL := Comando_SQL + 'fb_movto_estoque_vlr_total,';
              Comando_SQL := Comando_SQL + 'fb_movto_estoque_lote,';
              Comando_SQL := Comando_SQL + 'fb_movto_estoque_data,';
              Comando_SQL := Comando_SQL + 'fb_movto_estoque_qtde_atual)';
              Comando_SQL := Comando_SQL + ' Values(';

              Comando_SQL := Comando_SQL + Trim(Cod_Estoque) + ',';
              Comando_SQL := Comando_SQL + Trim(Nro_Ctrl_Estoque) + ',';
              Comando_SQL := Comando_SQL + #39 + Trim(Prod_Estoque) + #39 + ',';
              Comando_SQL := Comando_SQL + Trim(Nro_Nota_Etoque) + ',';
              Comando_SQL := Comando_SQL + Trim(Virgula_Ponto(Qtde_Estoque)) + ',';
              Comando_SQL := Comando_SQL + #39 + Trim(Desc_Estoque) + #39 + ',';
              Comando_SQL := Comando_SQL + Trim(Virgula_Ponto(Vlr_Unit_Estoque)) + ',';
              Comando_SQL := Comando_SQL + Trim(Virgula_Ponto(Vlr_Tot_Estoque)) + ',';
              Comando_SQL := Comando_SQL + Trim(Lote_Estoque) + ',';
              Comando_SQL := Comando_SQL + #39 + Inverte_Data_Plus(Trim(DateToStr(Date())),'amd','/') + #39 + ',';
              Comando_SQL := Comando_SQL + Trim(Virgula_Ponto(Atual_Estoque)) + ')';
