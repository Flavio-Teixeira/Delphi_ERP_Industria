unit Registro_Papeletas_Saidas_01;
...
type
  TRegistroPapeletasSaidas01 = class(TForm)
    Panel3: TPanel;
    BT_Incluir: TBitBtn;
    BT_Sair: TBitBtn;
    Panel1: TPanel;
  ...
  private
    ...
    procedure Imprime_OS_Ibrasmak(Posicao_Inicial, Posicao_Final: Integer);
...
var
  RegistroPapeletasSaidas01: TRegistroPapeletasSaidas01;
...
uses Conexao_BD, Rotinas_Gerais, Clientes_00, Ordem_02,
  ...
  Registro_Notas_Fiscais_Saidas_01, Registro_Papeletas_Saidas_00;
...
function TRegistroPapeletasSaidas01.ConversaoRecursiva(N: LongWord): string;
begin
     case N of
...
function TRegistroPapeletasSaidas01.Extenso(parmNumero: Real): string;
begin
...
function TRegistroPapeletasSaidas01.Letra_Maiuscula(Texto: String): string;
...
function TRegistroPapeletasSaidas01.Prepara_Volume(Posicao_Inicial, Posicao_Final: Integer): string;
...
function TRegistroPapeletasSaidas01.Valida_Dados(): Boolean;
...
begin
     ...
     Else
        ...
        If(Programa_Anterior.Text = '') Then
        Begin
           ConexaoBD.SQL_FB_Papeletas.Close;
           ConexaoBD.SQL_FB_Papeletas.SQL.Clear;
           ConexaoBD.SQL_FB_Papeletas.SQL.Add('Select * from fb_papeletas Where fb_papeleta_numero = ' + Trim(Nota_Numero.Text) + ' Order By fb_papeleta_data_emissao Desc');
           ConexaoBD.SQL_FB_Papeletas.Open;

           If ConexaoBD.SQL_FB_Papeletas.RecordCount > 0 Then
              Begin
              Erro          := 'Este Número de Papeleta Já Existe.';
              Campo_Retorno := 'Nota_Numero';
           End;
...
procedure TRegistroPapeletasSaidas01.Carrega_Transportadoras();
begin
     Ampulheta();
...
procedure TRegistroPapeletasSaidas01.Carrega_Pgto_Frete();
begin
...
procedure TRegistroPapeletasSaidas01.BT_SairClick(Sender: TObject);
begin
     RegistroPapeletasSaidas01.Close;
end;

procedure TRegistroPapeletasSaidas01.BT_ProcurarClick(Sender: TObject);
begin
     Ampulheta();
     Application.CreateForm(TClientes00,Clientes00);

     Clientes00.Programa_Anterior.Text := 'Papeletas-Inclusão';
...
procedure TRegistroPapeletasSaidas01.Nota_NumeroKeyPress(Sender: TObject;
  var Key: Char);
begin
...
procedure TRegistroPapeletasSaidas01.Nota_EmissaoKeyPress(Sender: TObject;
  var Key: Char);
begin
     If Key = #13 Then
        Begin
...
procedure TRegistroPapeletasSaidas01.Nota_EntradaKeyPress(Sender: TObject;
  var Key: Char);
begin
     If Key = #13 Then
        Begin
...
procedure TRegistroPapeletasSaidas01.Nota_RecebimentoKeyPress(Sender: TObject;
  var Key: Char);
begin
     If Key = #13 Then
        Begin
...
procedure TRegistroPapeletasSaidas01.Cliente_CFOPKeyPress(Sender: TObject;
  var Key: Char);
begin
     If Key = #13 Then
        Begin
...
procedure TRegistroPapeletasSaidas01.Nota_NaturezaKeyPress(Sender: TObject;
  var Key: Char);
begin
     If Key = #13 Then
        Begin
...
procedure TRegistroPapeletasSaidas01.Nota_Condicao_Pgto_1KeyPress(
...
procedure TRegistroPapeletasSaidas01.Nota_Condicao_Pgto_2KeyPress(
  Sender: TObject; var Key: Char);
begin
     So_Numero(Sender,Key);
...
procedure TRegistroPapeletasSaidas01.Nota_Condicao_Pgto_3KeyPress(
  Sender: TObject; var Key: Char);
begin
     So_Numero(Sender,Key);
...
procedure TRegistroPapeletasSaidas01.Nota_Condicao_Pgto_4KeyPress(
  Sender: TObject; var Key: Char);
begin
     So_Numero(Sender,Key);
...
procedure TRegistroPapeletasSaidas01.Nota_Aliquota_ISSKeyPress(
  Sender: TObject; var Key: Char);
begin
     So_Valor(Sender,Key);
...
procedure TRegistroPapeletasSaidas01.Nota_Valor_ISSKeyPress(Sender: TObject;
  var Key: Char);
begin
     So_Valor(Sender,Key);
...
procedure TRegistroPapeletasSaidas01.Nota_Valor_ServicosKeyPress(
  Sender: TObject; var Key: Char);
begin
     So_Valor(Sender,Key);
...
procedure TRegistroPapeletasSaidas01.Nota_Base_ICMSKeyPress(Sender: TObject;
  var Key: Char);
begin
     So_Valor(Sender,Key);
...
procedure TRegistroPapeletasSaidas01.Nota_Valor_ICMSKeyPress(Sender: TObject;
  var Key: Char);
begin
     So_Valor(Sender,Key);
...
procedure TRegistroPapeletasSaidas01.Nota_Base_ICMS_SubKeyPress(
  Sender: TObject; var Key: Char);
begin
     So_Valor(Sender,Key);
...
procedure TRegistroPapeletasSaidas01.Nota_Valor_ICMS_SubKeyPress(
  Sender: TObject; var Key: Char);
begin
     So_Valor(Sender,Key);
...
procedure TRegistroPapeletasSaidas01.Nota_Valor_ProdutoKeyPress(
  Sender: TObject; var Key: Char);
begin
     So_Valor(Sender,Key);
...
procedure TRegistroPapeletasSaidas01.Valor_FreteKeyPress(Sender: TObject;
  var Key: Char);
begin
     So_Valor(Sender,Key);
...
procedure TRegistroPapeletasSaidas01.Nota_Valor_SeguroKeyPress(
  Sender: TObject; var Key: Char);
begin
     So_Valor(Sender,Key);
...
procedure TRegistroPapeletasSaidas01.Nota_Outras_DespesasKeyPress(
  Sender: TObject; var Key: Char);
begin
     So_Valor(Sender,Key);
...
procedure TRegistroPapeletasSaidas01.Valor_IPIKeyPress(Sender: TObject;
  var Key: Char);
begin
     So_Valor(Sender,Key);
...
procedure TRegistroPapeletasSaidas01.Valor_TotalKeyPress(Sender: TObject;
  var Key: Char);
begin
     So_Valor(Sender,Key);
...
procedure TRegistroPapeletasSaidas01.Transportadora_CNPJKeyPress(
  Sender: TObject; var Key: Char);
begin
     If Key = #13 Then
        Begin
...
procedure TRegistroPapeletasSaidas01.Transportadora_NomeKeyPress(
  Sender: TObject; var Key: Char);
begin
     If Key = #13 Then
        Begin
...
procedure TRegistroPapeletasSaidas01.Nota_Pgto_FreteKeyPress(Sender: TObject;
  var Key: Char);
begin
     If Key = #13 Then
        Begin
...
procedure TRegistroPapeletasSaidas01.Qtde_VolumeKeyPress(Sender: TObject;
  var Key: Char);
begin
     So_Numero(Sender,Key);
...
procedure TRegistroPapeletasSaidas01.EspecieKeyPress(Sender: TObject;
  var Key: Char);
begin
     If Key = #13 Then
        Begin
...
procedure TRegistroPapeletasSaidas01.MarcaKeyPress(Sender: TObject;
  var Key: Char);
begin
     If Key = #13 Then
        Begin
...
procedure TRegistroPapeletasSaidas01.Peso_BrutoKeyPress(Sender: TObject;
  var Key: Char);
begin
     So_Valor(Sender,Key);
...
procedure TRegistroPapeletasSaidas01.Peso_LiquidoKeyPress(
  Sender: TObject; var Key: Char);
begin
     So_Valor(Sender,Key);
...
procedure TRegistroPapeletasSaidas01.Nota_ObsKeyPress(Sender: TObject;
  var Key: Char);
begin
     If Key = #13 Then
        Begin
...
procedure TRegistroPapeletasSaidas01.Exibe_Grid_Produtos();
...
begin
     ...
     If Trim(Programa_Anterior.Text) = 'Alteração-Exclusão' Then
        ...
        ConexaoBD.SQL_FB_Papeletas_Produtos.SQL.Add('Select * from fb_papeletas_produtos Where fb_papeleta_produto_numero = ' + Trim(Nota_Numero.Text) + ' Order By fb_papeleta_produto_posicao');
        ...
        If ConexaoBD.SQL_FB_Papeletas_Produtos.RecordCount > 0 Then
           ...
           While Not ConexaoBD.SQL_FB_Papeletas_Produtos.Eof Do
                 ...
                 SGD_Produtos.Cells[1,Ind] := ConexaoBD.SQL_FB_Papeletas_Produtosfb_papeleta_produto_qtde.Text;
                 SGD_Produtos.Cells[2,Ind] := ConexaoBD.SQL_FB_Papeletas_Produtosfb_papeleta_produto_codigo.Text;
                 SGD_Produtos.Cells[4,Ind] := ConexaoBD.SQL_FB_Papeletas_Produtosfb_papeleta_produto_desc.Text;
                 SGD_Produtos.Cells[5,Ind] := IntToStr(ConexaoBD.SQL_FB_Papeletas_Produtosfb_papeleta_produto_lote.AsInteger);

                 //*** Busca o Peso do Produto ***

                 If Trim(ConexaoBD.SQL_FB_Papeletas_Produtosfb_papeleta_produto_codigo.Text) <> '' Then
                    Begin
                    ConexaoBD.SQL_Produtos.Close;
                    ConexaoBD.SQL_Produtos.SQL.Clear;
                    ConexaoBD.SQL_Produtos.SQL.Add('Select * from fb_produtos Where fb_produto_codigo = ' +#39+ Trim(ConexaoBD.SQL_FB_Papeletas_Produtosfb_papeleta_produto_codigo.Text) + #39);
                    ...
                    If Not ConexaoBD.SQL_Produtos.Eof Then
                       ...
                       Peso  := Peso + ((ConexaoBD.SQL_Produtosfb_produto_peso.AsVariant) * (StrToFloat(Ponto_Virgula(ConexaoBD.SQL_FB_Papeletas_Produtosfb_papeleta_produto_qtde.Text)) ));

                       //*** Retorna ao Carregamento Normal ***

                       Vlr_Exibicao := Trim(Virgula_Ponto(ConexaoBD.SQL_FB_Papeletas_Produtosfb_papeleta_produto_vlr_uni.Text));
                       ...
                       Vlr_Exibicao := Trim(Virgula_Ponto(ConexaoBD.SQL_FB_Papeletas_Produtosfb_papeleta_produto_vlr_tot.Text));
                       Val(Vlr_Exibicao,Vlr_Numero,Erro);
                       Str(Vlr_Numero:13:2,Vlr_Exibicao);
                       Vlr_Exibicao := Ponto_Virgula(Trim(Vlr_Exibicao));
                       ...
                       SGD_Produtos.Cells[9,Ind]  := ConexaoBD.SQL_FB_Papeletas_Produtosfb_papeleta_produto_posicao.Text;
                    ...
                    Else
                       ...
                       Peso  := Peso + ((0) * (StrToFloat(Ponto_Virgula(ConexaoBD.SQL_FB_Papeletas_Produtosfb_papeleta_produto_qtde.Text)) ));
...
procedure TRegistroPapeletasSaidas01.FormShow(Sender: TObject);
begin
     ...
     Ampulheta();
      ...
      ConexaoBD.SQL_Natureza_Operacao.SQL.Add('Select * from fb_naturezas_operacao Order By fb_natureza_operacao_descricao_curta');
      ...
      If ConexaoBD.SQL_Natureza_Operacao.RecordCount > 0 Then
        ...
        While Not ConexaoBD.SQL_Natureza_Operacao.Eof Do
          begin
          Natureza_Operacao.Items.Add(IntToStr(ConexaoBD.SQL_Natureza_Operacaofb_natureza_operacao_nro.AsInteger)+' - '+ConexaoBD.SQL_Natureza_Operacaofb_natureza_operacao_descricao_curta.AsString);
...
procedure TRegistroPapeletasSaidas01.Nota_Valor_ProdutoExit(Sender: TObject);
begin
...
procedure TRegistroPapeletasSaidas01.Valor_FreteExit(Sender: TObject);
begin
...
procedure TRegistroPapeletasSaidas01.Valor_TotalExit(Sender: TObject);
begin
...
procedure TRegistroPapeletasSaidas01.BT_AdicionarClick(Sender: TObject);
begin
     If Trim(Cliente_Codigo.Text) <> '' Then
        Begin
        Ampulheta();
        ...
        AdicionaProdutoRelacao.Programa_Anterior.Text    := 'Papeletas-Inclusão';
...
procedure TRegistroPapeletasSaidas01.SGD_ProdutosDblClick(Sender: TObject);
begin
        Application.CreateForm(TAdicionaQtdeProduto,AdicionaQtdeProduto);

        AdicionaQtdeProduto.Programa_Anterior.Text       := 'Papeletas-Inclusão';
...
procedure TRegistroPapeletasSaidas01.BT_IncluirClick(Sender: TObject);
...
procedure TRegistroPapeletasSaidas01.FormClose(Sender: TObject;
...
begin
     ...
     If Trim(RegistroPapeletasSaidas00.Numero_Nota.Text) <> '' Then
        Begin
        ConexaoBD.SQL_FB_Papeletas.SQL.Add('Select * from fb_papeletas Where fb_papeleta_numero = ' + Trim(RegistroNotasFiscaisSaidas00.Numero_Nota.Text) + ' Order By fb_nota_fiscal_data_emissao Desc, fb_nota_fiscal_numero Desc');
        End
     Else
        Begin
        ConexaoBD.SQL_FB_Papeletas.SQL.Add('Select * from fb_papeletas Where (fb_papeleta_data_emissao >='+#39+Inverte_Data_Plus(Trim(RegistroPapeletasSaidas00.Data_Inicial.Text),'amd','/')+#39+' and fb_papeleta_data_emissao <='+#39+Inverte_Data_Plus(Trim(RegistroPapeletasSaidas00.Data_Final.Text),'amd','/')+#39+') Order By fb_papeleta_data_emissao Desc, fb_papeleta_numero Desc');
     End;

     ConexaoBD.SQL_FB_Papeletas.Open;

     RegistroPapeletasSaidas00.Total_Pedidos_Ibrasmak.Caption := IntToStr(ConexaoBD.SQL_FB_Papeletas.RecordCount);
     ...
     Action := caFree;
     Release;
     RegistroPapeletasSaidas01 := Nil;
end;

procedure TRegistroPapeletasSaidas01.Cliente_DescontoExit(
  Sender: TObject);
begin
...
procedure TRegistroPapeletasSaidas01.Cliente_DescontoKeyPress(
  Sender: TObject; var Key: Char);
begin
     So_Valor(Sender,Key);
...
procedure TRegistroPapeletasSaidas01.Cliente_Condicao_Pgto_1KeyPress(
  Sender: TObject; var Key: Char);
begin
     If Key = #13 Then
        Begin
...
procedure TRegistroPapeletasSaidas01.Cliente_Condicao_Pgto_2KeyPress(
  Sender: TObject; var Key: Char);
begin
     If Key = #13 Then
        Begin
...
procedure TRegistroPapeletasSaidas01.Cliente_Condicao_Pgto_3KeyPress(
  Sender: TObject; var Key: Char);
begin
     If Key = #13 Then
        Begin
...
procedure TRegistroPapeletasSaidas01.Cliente_Condicao_Pgto_4KeyPress(
  Sender: TObject; var Key: Char);
begin
     If Key = #13 Then
        Begin
...
procedure TRegistroPapeletasSaidas01.Natureza_OperacaoKeyPress(
  Sender: TObject; var Key: Char);
begin
     If Key = #13 Then
        Begin
...
procedure TRegistroPapeletasSaidas01.Cliente_Natureza_OperacaoKeyPress(
  Sender: TObject; var Key: Char);
begin
     If Key = #13 Then
        Begin
...
procedure TRegistroPapeletasSaidas01.Tipo_Nota_SaidaKeyPress(
  Sender: TObject; var Key: Char);
begin
     If Key = #13 Then
        Begin
...
procedure TRegistroPapeletasSaidas01.Tipo_Nota_EntradaKeyPress(
  Sender: TObject; var Key: Char);
begin
     If Key = #13 Then
        Begin
...
procedure TRegistroPapeletasSaidas01.Cliente_Tipo_TransporteKeyPress(
  Sender: TObject; var Key: Char);
begin
     If Key = #13 Then
        Begin
...
procedure TRegistroPapeletasSaidas01.Cliente_Pgto_FreteKeyPress(
  Sender: TObject; var Key: Char);
begin
     If Key = #13 Then
        Begin
...
procedure TRegistroPapeletasSaidas01.Cliente_TransportadoraKeyPress(
  Sender: TObject; var Key: Char);
begin
     If Key = #13 Then
        Begin
...
procedure TRegistroPapeletasSaidas01.Cliente_Emite_LoteKeyPress(
  Sender: TObject; var Key: Char);
begin
     If Key = #13 Then
        Begin
...
procedure TRegistroPapeletasSaidas01.Cliente_Aliquota_ICMSKeyPress(
  Sender: TObject; var Key: Char);
begin
     So_Valor(Sender,Key);
...
procedure TRegistroPapeletasSaidas01.Cliente_Base_ReduzidaKeyPress(
  Sender: TObject; var Key: Char);
begin
     So_Valor(Sender,Key);
...
procedure TRegistroPapeletasSaidas01.Cliente_Ordem_CompraKeyPress(
  Sender: TObject; var Key: Char);
begin
     If Key = #13 Then
        Begin
...
procedure TRegistroPapeletasSaidas01.SGD_ProdutosKeyPress(
  Sender: TObject; var Key: Char);
begin
  If Key = #13 Then
  Begin
...
procedure TRegistroPapeletasSaidas01.Totaliza_Pedido();
...
procedure TRegistroPapeletasSaidas01.Prepara_Condicao();
...
procedure TRegistroPapeletasSaidas01.Cliente_Condicao_Pgto_Vlr_1KeyPress(
  Sender: TObject; var Key: Char);
begin
     So_Valor(Sender,Key);
...
procedure TRegistroPapeletasSaidas01.Cliente_Condicao_Pgto_Vlr_2KeyPress(
  Sender: TObject; var Key: Char);
begin
     So_Valor(Sender,Key);
...
procedure TRegistroPapeletasSaidas01.Cliente_Condicao_Pgto_Vlr_3KeyPress(
  Sender: TObject; var Key: Char);
begin
     So_Valor(Sender,Key);
...
procedure TRegistroPapeletasSaidas01.Cliente_Condicao_Pgto_Vlr_4KeyPress(
  Sender: TObject; var Key: Char);
begin
     So_Valor(Sender,Key);
...
procedure TRegistroPapeletasSaidas01.Cliente_Condicao_Pgto_Vlr_1Exit(
  Sender: TObject);
begin
...
procedure TRegistroPapeletasSaidas01.Cliente_Condicao_Pgto_Vlr_2Exit(
  Sender: TObject);
begin
...
procedure TRegistroPapeletasSaidas01.Cliente_Condicao_Pgto_Vlr_3Exit(
  Sender: TObject);
begin
...
procedure TRegistroPapeletasSaidas01.Cliente_Condicao_Pgto_Vlr_4Exit(
  Sender: TObject);
begin
...
procedure TRegistroPapeletasSaidas01.BT_Adicionar_ForaClick(
  Sender: TObject);
begin
     If Trim(Cliente_Codigo.Text) <> '' Then
        Begin
        ...
        AdicionaQtdeProduto02.Programa_Anterior.Text          := 'Papeletas-Inclusão';
...
procedure TRegistroPapeletasSaidas01.Imprime_OS();
...
begin
     ...
     For Ind_Produto := 1 To (SGD_Produtos.RowCount - 1) Do
         ...
         If Conta_Produto >= 14 Then
            ...
            Imprime_OS_Ibrasmak(Posicao_Inicial, Posicao_Final);
     ...
     If Posicao_Nota_Boleto > 0 Then
        ...
        For Nro_Nota_Boleto_INI := (StrToInt(ETP_Numero_Nota.Text) - Posicao_Nota_Boleto) To Nro_Nota_Boleto_FIM Do
            Begin
            Comando_SQL := 'select * from fb_papeletas where fb_papeleta_numero = ' + Trim(IntToStr(Nro_Nota_Boleto_INI));
            ...
            If ConexaoBD.SQL_FB_Papeletas.RecordCount > 0 Then
               Begin
               Boleto_Docto_1 := Boleto_Docto_1 + ' / ' + ConexaoBD.SQL_FB_Papeletasfb_papeleta_dup_nro_1.Text;
               Boleto_Docto_2 := Boleto_Docto_2 + ' / ' + ConexaoBD.SQL_FB_Papeletasfb_papeleta_dup_nro_2.Text;
               Boleto_Docto_3 := Boleto_Docto_3 + ' / ' + ConexaoBD.SQL_FB_Papeletasfb_papeleta_dup_nro_3.Text;
               Boleto_Docto_4 := Boleto_Docto_4 + ' / ' + ConexaoBD.SQL_FB_Papeletasfb_papeleta_dup_nro_4.Text;

               Vlr_Nota_Boleto_1 := Vlr_Nota_Boleto_1 + ConexaoBD.SQL_FB_Papeletasfb_papeleta_dup_vlr_1.AsFloat;
               Vlr_Nota_Boleto_2 := Vlr_Nota_Boleto_2 + ConexaoBD.SQL_FB_Papeletasfb_papeleta_dup_vlr_2.AsFloat;
               Vlr_Nota_Boleto_3 := Vlr_Nota_Boleto_3 + ConexaoBD.SQL_FB_Papeletasfb_papeleta_dup_vlr_3.AsFloat;
               Vlr_Nota_Boleto_4 := Vlr_Nota_Boleto_4 + ConexaoBD.SQL_FB_Papeletasfb_papeleta_dup_vlr_4.AsFloat;

               Boleto_Obs := Boleto_Obs + Trim(ConexaoBD.SQL_FB_Papeletasfb_papeleta_numero.Text) + ' - R$ ' + Trim(ConexaoBD.SQL_FB_Papeletasfb_papeleta_dup_vlr_1.Text) + ' / ';

               Comando_SQL := 'Update fb_papeletas Set ';
               Comando_SQL := Comando_SQL + 'fb_papeleta_boleto_emissao = ' +#39+ 'N' +#39+ ', ';
               Comando_SQL := Comando_SQL + 'fb_papeleta_boleto_obs = ' +#39 + #39+ ', ';
               Comando_SQL := Comando_SQL + 'fb_papeleta_boleto_docto_1 = ' +#39 + #39+ ', ';
               Comando_SQL := Comando_SQL + 'fb_papeleta_boleto_docto_2 = ' +#39 + #39+ ', ';
               Comando_SQL := Comando_SQL + 'fb_papeleta_boleto_docto_3 = ' +#39 + #39+ ', ';
               Comando_SQL := Comando_SQL + 'fb_papeleta_boleto_docto_4 = ' +#39 + #39+ ', ';
               Comando_SQL := Comando_SQL + 'fb_papeleta_boleto_vlr_1 = 0.00, ';
               Comando_SQL := Comando_SQL + 'fb_papeleta_boleto_vlr_2 = 0.00, ';
               Comando_SQL := Comando_SQL + 'fb_papeleta_boleto_vlr_3 = 0.00, ';
               Comando_SQL := Comando_SQL + 'fb_papeleta_boleto_vlr_4 = 0.00 ';
               Comando_SQL := Comando_SQL + 'where fb_papeleta_numero = ' + Trim(IntToStr(Nro_Nota_Boleto_INI));
     ...
     Comando_SQL := 'Update fb_papeletas Set ';
     Comando_SQL := Comando_SQL + 'fb_papeleta_boleto_emissao = ' +#39+ 'S' +#39+ ', ';
     Comando_SQL := Comando_SQL + 'fb_papeleta_boleto_obs = ' +#39 + Trim(Boleto_Obs) + #39+ ', ';
     Comando_SQL := Comando_SQL + 'fb_papeleta_boleto_docto_1 = ' +#39 + Trim(Boleto_Docto_1) + #39+ ', ';
     Comando_SQL := Comando_SQL + 'fb_papeleta_boleto_docto_2 = ' +#39 + Trim(Boleto_Docto_2) + #39+ ', ';
     Comando_SQL := Comando_SQL + 'fb_papeleta_boleto_docto_3 = ' +#39 + Trim(Boleto_Docto_3) + #39+ ', ';
     Comando_SQL := Comando_SQL + 'fb_papeleta_boleto_docto_4 = ' +#39 + Trim(Boleto_Docto_4) + #39+ ', ';
     Comando_SQL := Comando_SQL + 'fb_papeleta_boleto_vlr_1 = ' + Virgula_Ponto(FloatToStr(Vlr_Nota_Boleto_1)) + ', ';
     Comando_SQL := Comando_SQL + 'fb_papeleta_boleto_vlr_2 = ' + Virgula_Ponto(FloatToStr(Vlr_Nota_Boleto_2)) + ', ';
     Comando_SQL := Comando_SQL + 'fb_papeleta_boleto_vlr_3 = ' + Virgula_Ponto(FloatToStr(Vlr_Nota_Boleto_3)) + ', ';
     Comando_SQL := Comando_SQL + 'fb_papeleta_boleto_vlr_4 = ' + Virgula_Ponto(FloatToStr(Vlr_Nota_Boleto_4)) + ' ';
     Comando_SQL := Comando_SQL + 'where fb_papeleta_numero = ' + Trim(IntToStr(Nro_Nota_Boleto_INI));
...
procedure TRegistroPapeletasSaidas01.Imprime_Nota();
...
begin
     ...
     //Novo
     If Imprime_Nota_Tela.Checked = False Then
         Begin
...
{procedure TRegistroPapeletasSaidas01.Imprime_Nota_Ibrasmak(Posicao_Inicial, Posicao_Final: Integer);
...
begin
     ...
     Imprimir.PoeStr(Linha,013, Exibe_Nro_Impressao(Trim(BC_ICMS_Str),10));
...
procedure TRegistroPapeletasSaidas01.Grava_Nota_Ibrasmak(Posicao_Inicial, Posicao_Final: Integer);
...
begin
     ...
     Comando_SQL := 'Insert into fb_papeletas(';
     Comando_SQL := Comando_SQL + 'fb_papeleta_numero, ';
     Comando_SQL := Comando_SQL + 'fb_papeleta_codigo_tipo, ';
     Comando_SQL := Comando_SQL + 'fb_papeleta_codigo, ';
     Comando_SQL := Comando_SQL + 'fb_papeleta_nome, ';
     Comando_SQL := Comando_SQL + 'fb_papeleta_desconto, ';
     Comando_SQL := Comando_SQL + 'fb_papeleta_tipo_fatura, ';
     Comando_SQL := Comando_SQL + 'fb_papeleta_emite_lote, ';
     Comando_SQL := Comando_SQL + 'fb_papeleta_tipo_transp, ';
     Comando_SQL := Comando_SQL + 'fb_papeleta_transporta, ';
     Comando_SQL := Comando_SQL + 'fb_papeleta_valor_pedido, ';
     Comando_SQL := Comando_SQL + 'fb_papeleta_valor_total, ';
     Comando_SQL := Comando_SQL + 'fb_papeleta_observacao, ';
     Comando_SQL := Comando_SQL + 'fb_papeleta_observacao_log, ';
     Comando_SQL := Comando_SQL + 'fb_papeleta_pgto_frete, ';
     Comando_SQL := Comando_SQL + 'fb_papeleta_natureza_oper, ';
     Comando_SQL := Comando_SQL + 'fb_papeleta_data_emissao, ';
     Comando_SQL := Comando_SQL + 'fb_papeleta_estado, ';
     Comando_SQL := Comando_SQL + 'fb_papeleta_vendedor, ';
     Comando_SQL := Comando_SQL + 'fb_papeleta_banco, ';
     Comando_SQL := Comando_SQL + 'fb_papeleta_valor_frete, ';
     Comando_SQL := Comando_SQL + 'fb_papeleta_cfop, ';
     Comando_SQL := Comando_SQL + 'fb_papeleta_ordem_compra, ';
     Comando_SQL := Comando_SQL + 'fb_papeleta_dup_dt_vcto_1, ';
     Comando_SQL := Comando_SQL + 'fb_papeleta_dup_vlr_1, ';
     Comando_SQL := Comando_SQL + 'fb_papeleta_dup_dt_vcto_2, ';
     Comando_SQL := Comando_SQL + 'fb_papeleta_dup_vlr_2, ';
     Comando_SQL := Comando_SQL + 'fb_papeleta_dup_dt_vcto_3, ';
     Comando_SQL := Comando_SQL + 'fb_papeleta_dup_vlr_3, ';
     Comando_SQL := Comando_SQL + 'fb_papeleta_dup_dt_vcto_4, ';
     Comando_SQL := Comando_SQL + 'fb_papeleta_dup_vlr_4) ';
     ...
     For Ind := Posicao_Inicial To Posicao_Final Do
         ...
         If StrToFloat(Valor_Inteiro) > 0 Then
            ...
            Comando_SQL := 'Insert into fb_papeletas_produtos(';
            Comando_SQL := Comando_SQL + 'fb_papeleta_produto_numero,';
            Comando_SQL := Comando_SQL + 'fb_papeleta_produto_codigo,';
            Comando_SQL := Comando_SQL + 'fb_papeleta_produto_qtde,';
            Comando_SQL := Comando_SQL + 'fb_papeleta_produto_desc,';
            Comando_SQL := Comando_SQL + 'fb_papeleta_produto_vlr_uni,';
            Comando_SQL := Comando_SQL + 'fb_papeleta_produto_vlr_tot,';
            Comando_SQL := Comando_SQL + 'fb_papeleta_produto_lote, ';
            Comando_SQL := Comando_SQL + 'fb_papeleta_produto_posicao, ';
            Comando_SQL := Comando_SQL + 'fb_papeleta_produto_vlr_ipi)';
            Comando_SQL := Comando_SQL + ' Values(';
            Comando_SQL := Comando_SQL + Trim(Nota_Numero.Text) + ',';
     ...
     Comando_SQL := Comando_SQL + ' Values(';
     Comando_SQL := Comando_SQL + #39 + Trim(Cliente_Codigo.Text) + #39 + ',';
     Comando_SQL := Comando_SQL + #39 + 'Orçamento' + #39 + ',';
     Comando_SQL := Comando_SQL + Trim(Nota_Numero.Text) + ',';
     Comando_SQL := Comando_SQL + #39 + Trim(Inverte_Data_Plus(Nota_Emissao.Text,'amd','/')) + #39 + ',';
...
procedure TRegistroPapeletasSaidas01.BT_ExcluirClick(Sender: TObject);
begin
     If Confirma('Confirma a Exclusão desta Nota-Fiscal?') = 6 Then
        ...
        ConexaoBD.SQL_Comunitario.SQL.Clear;
        ConexaoBD.SQL_Comunitario.SQL.Add('Delete from fb_papeletas Where fb_papeleta_numero = ' +  Trim(Nota_Numero.Text));
        ConexaoBD.SQL_Comunitario.ExecSQL;

        //*** Deleta os Itens do Pedido Principal ***

        ConexaoBD.SQL_Comunitario.SQL.Clear;
        ConexaoBD.SQL_Comunitario.SQL.Add('Delete from fb_papeletas_produtos Where fb_papeleta_produto_numero = ' +  Trim(Nota_Numero.Text));
        ConexaoBD.SQL_Comunitario.ExecSQL;

        ConexaoBD.SQL_Comunitario.SQL.Clear;
        ConexaoBD.SQL_Comunitario.SQL.Add('Delete from fb_historicos Where fb_historico_codigo_cliente = ' +#39+ Trim(Cliente_Codigo.Text) +#39+ ' And fb_historico_tipo_faturamento = ' +#39+ 'Orçamento' +#39+ ' And fb_historico_nro_nota = ' + Trim(Nota_Numero.Text) );
        ConexaoBD.SQL_Comunitario.ExecSQL;
...
procedure TRegistroPapeletasSaidas01.BT_AlterarClick(Sender: TObject);
begin
     If Valida_Dados() Then
        Begin
...
procedure TRegistroPapeletasSaidas01.BT_Procurar_FornecedoresClick(
  Sender: TObject);
begin
    Ampulheta();
    Application.CreateForm(TFornecedor00,Fornecedor00);

    Fornecedor00.Programa_Anterior.Text := 'Papeletas-Inclusão';
...
procedure TRegistroPapeletasSaidas01.Imprime_OS_Ibrasmak(Posicao_Inicial, Posicao_Final: Integer);
...
begin
     ...
     Linha := Linha + 1;
     Imprimir.PoeStr(Linha,001, '* Ibrasmak');
     ...
     Linha := Linha + 1;
     Imprimir.PoeStr(Linha,001, '*');
     Imprimir.PoeStr(Linha,048, 'EMISSÃO DE ORÇAMENTO');
     ...
     Imprimir.PoeStr(Linha,088, Trim(Natureza_Operacao.Text));
     Imprimir.PoeStr(Linha,106, '      OS.Nro.:');
     ...
     Linha := Linha + 2;
     Imprimir.PoeStr(Linha,001, 'Nro.OS        Data        Cond.Pgto / Vencto');

     Linha := Linha + 1;
     Imprimir.PoeStr(Linha,001, '------------  ----------  ------------------');

     Linha := Linha + 1;
     Imprimir.PoeStr(Linha,001, Trim(Nota_Numero.Text));
     Imprimir.PoeStr(Linha,015, Trim(Nota_Emissao.Text));

//******************************************************************************************

     If (Trim(Cliente_Condicao_Pgto_4.Text) <> '/  /') Then
        Begin
        Imprimir.PoeStr(Linha,027, Trim(Cliente_Condicao_Pgto_1.Text) + '      - ' + Trim(Cliente_Condicao_Pgto_2.Text) + '      - ' + Trim(Cliente_Condicao_Pgto_3.Text) + '      - ' +  Trim(Cliente_Condicao_Pgto_4.Text) );
        Linha := Linha + 1;
        Imprimir.PoeStr(Linha,027, 'R$ ' + Trim(Cliente_Condicao_Pgto_Vlr_1.Text) );
        Imprimir.PoeStr(Linha,045, 'R$ ' + Trim(Cliente_Condicao_Pgto_Vlr_2.Text) );
        Imprimir.PoeStr(Linha,063, 'R$ ' + Trim(Cliente_Condicao_Pgto_Vlr_3.Text) );
        Imprimir.PoeStr(Linha,081, 'R$ ' + Trim(Cliente_Condicao_Pgto_Vlr_4.Text) );
        End
     Else If (Trim(Cliente_Condicao_Pgto_3.Text) <> '/  /') Then
        Begin
        Imprimir.PoeStr(Linha,027, Trim(Cliente_Condicao_Pgto_1.Text) + '      - ' + Trim(Cliente_Condicao_Pgto_2.Text) + '      - ' + Trim(Cliente_Condicao_Pgto_3.Text) );
        Linha := Linha + 1;
        Imprimir.PoeStr(Linha,027, 'R$ ' + Trim(Cliente_Condicao_Pgto_Vlr_1.Text) );
        Imprimir.PoeStr(Linha,045, 'R$ ' + Trim(Cliente_Condicao_Pgto_Vlr_2.Text) );
        Imprimir.PoeStr(Linha,063, 'R$ ' + Trim(Cliente_Condicao_Pgto_Vlr_3.Text) );
        End
     Else If (Trim(Cliente_Condicao_Pgto_2.Text) <> '/  /') Then
        Begin
        Imprimir.PoeStr(Linha,027, Trim(Cliente_Condicao_Pgto_1.Text) + '      - ' + Trim(Cliente_Condicao_Pgto_2.Text) );
        Linha := Linha + 1;
        Imprimir.PoeStr(Linha,027, 'R$ ' + Trim(Cliente_Condicao_Pgto_Vlr_1.Text) );
        Imprimir.PoeStr(Linha,045, 'R$ ' + Trim(Cliente_Condicao_Pgto_Vlr_2.Text) );
        End
     Else If (Trim(Cliente_Condicao_Pgto_1.Text) <> '/  /') Then
        Begin
        Imprimir.PoeStr(Linha,027, Trim(Cliente_Condicao_Pgto_1.Text) );
        Linha := Linha + 1;
        Imprimir.PoeStr(Linha,027, 'R$ ' + Trim(Cliente_Condicao_Pgto_Vlr_1.Text) );
        End
     Else
        Begin
        Imprimir.PoeStr(Linha,027, 'À VISTA');
     End;
...
procedure TRegistroPapeletasSaidas01.Natureza_OperacaoChange(
  Sender: TObject);
var
  Nro_Natureza : string;

begin
     Nro_Natureza := Obtem_Nro_Antes_Traco(Natureza_Operacao.Text);
