...
type
  THistoricoClientes03 = class(TForm)
    GroupBox1: TGroupBox;
    Label1: TLabel;
    Label2: TLabel;
    editCodigo: TEdit;
...
var
  HistoricoClientes03: THistoricoClientes03;
...
procedure THistoricoClientes03.FormShow(Sender: TObject);
begin
    Ampulheta();
    Carrega_Clientes();
    Seta();
...
procedure THistoricoClientes03.BitBtn1Click(Sender: TObject);
begin
    HistoricoClientes03.Close;
end;

procedure THistoricoClientes03.Carrega_Clientes;
var
    Ind: Integer;
...
procedure THistoricoClientes03.SGD_SaidasDblClick(Sender: TObject);
...
begin
     If SGD_Saidas.Cells[1,SGD_Saidas.Row] <> '' Then
        ...
        HistoricoClientes03.Visible := False;
        ...
        HistoricoClientes01.Nro_Codigo_Cliente.Text           := ConexaoBD.SQL_Clientesfb_cliente_codigo.AsString;
        ...
        HistoricoClientes01.Cliente_Observacoes.Lines.Add(ConexaoBD.SQL_Clientesfb_cliente_observacoes.Text);
        ...
        HistoricoClientes03.Visible := True;
     End;
end;
