object RegistroPapeletasSaidas00: TRegistroPapeletasSaidas00
  Left = 302
  Top = 180
  BorderIcons = [biSystemMenu, biMinimize]
  BorderStyle = bsSingle
  Caption = 'Registro de Papeletas'
  ClientHeight = 543
  ClientWidth = 762
  Color = clBtnFace
