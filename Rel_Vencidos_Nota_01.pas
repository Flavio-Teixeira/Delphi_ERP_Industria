...
type
  TRelVencidosNota01 = class(TForm)
...
var
  RelVencidosNota01: TRelVencidosNota01;

implementation

uses Conexao_BD, Rotinas_Gerais, Rel_Vencidos_Nota_00;

{$R *.dfm}

procedure TRelVencidosNota01.FormCreate(Sender: TObject);
begin
