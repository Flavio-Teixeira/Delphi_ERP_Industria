     ...
     If Trim(Cliente_Codigo.Text) <> '' Then
        ...
        ConexaoBD.SQL_FB_Clientes.Open;
         ...
         If Trim(ConexaoBD.SQL_FB_Clientesfb_cliente_status_credito.Text) = 'S' Then
           Begin
           //Erro          := 'Cliente em Atraso, a OS não será efetuada.';
...
begin
     If Valida_Dados() Then
        ...
        //*** Incluir Observações no Cliente e Nro da Transportadora ***
...
begin
     ...
     //*** Inicializa as Variáveis de Controle de Estoque ***
     Ctrl_Estoque     := False;
     Nro_Ctrl_Estoque := '';
end;
...
begin
     If Trim(Procura_Produto.Text) <> '' Then
        ...
        For Ind := 1 To (SGD_Produtos.RowCount - 1) Do
            Begin
            If Trim(Procura_Tipo.Text) = 'Código' Then
               Begin
               Busca_Codigo  := UpperCase(Trim(SGD_Produtos.Cells[1,Ind]));
               End
            Else If Trim(Procura_Tipo.Text) = 'Referência' Then
               Begin
               Busca_Codigo  := UpperCase(Trim(SGD_Produtos.Cells[2,Ind]));
               End
            Else If Trim(Procura_Tipo.Text) = 'Descrição' Then
               Begin
...
begin
     Application.CreateForm(TTransportadoras00,Transportadoras00);
     Transportadoras00.Programa_Anterior.Text := 'Pedidos-Inclusão';       
     Transportadoras00.ShowModal;
end;
